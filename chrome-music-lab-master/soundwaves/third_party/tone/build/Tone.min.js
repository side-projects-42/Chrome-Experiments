  ...
  Main(function () {
    ...
    return (
      ...
      (s.prototype.set = function (e, i, n) {
        ...
        for (r in e) {
          ...
          (u = a[r]),
            t(u) ||
              ((s.Signal && u instanceof s.Signal) ||
              (s.Param && u instanceof s.Param)
                ? u.value !== i && (t(n) ? (u.value = i) : u.rampTo(i, n))
      ...
      (s.prototype.get = function (i) {
        ...
        for (
          t(i)
            ? (i = this._collectDefaults(this.constructor))
            : this.isString(i) && (i = [i]),
            n = {},
            o = 0;
          o < i.length;
          ...
          if (((r = i[o]), (a = this), (l = n), -1 !== r.indexOf("."))) {
            for (h = r.split("."), u = 0; u < h.length - 1; u++)
              (c = h[u]), (l[c] = l[c] || {}), (l = l[c]), (a = a[c]);
            r = h[h.length - 1];
          }
          (p = a[r]),
            this.isObject(i[r])
              ? (l[r] = p.get())
              : s.Signal && p instanceof s.Signal
              ? (l[r] = p.value)
              : s.Param && p instanceof s.Param
              ? (l[r] = p.value)
      ...
      (s.prototype._collectDefaults = function (e) {
        ...
        if ((t(e.defaults) || (n = Object.keys(e.defaults)), !t(e._super)))
          for (i = this._collectDefaults(e._super), s = 0; s < i.length; s++)
      ...
      (s.context = i),
      (s.prototype.context = s.context),
      (s.prototype.bufferSize = 2048),
      (s.prototype.blockTime = 128 / s.context.sampleRate),
      ...
      (s.prototype.connect = function (t, e, i) {
        return (
          Array.isArray(this.output)
            ? ((e = this.defaultArg(e, 0)), this.output[e].connect(t, 0, i))
            : this.output.connect(t, e, i),
          this
        );
      }),
      (s.prototype.disconnect = function (t) {
        return (
          Array.isArray(this.output)
            ? ((t = this.defaultArg(t, 0)), this.output[t].disconnect())
      ...
      (s.prototype.connectSeries = function () {
        ...
        if (arguments.length > 1)
          for (t = arguments[0], e = 1; e < arguments.length; e++)
            (i = arguments[e]), t.connect(i), (t = i);
        return this;
      }),
      (s.prototype.connectParallel = function () {
        ...
        if (arguments.length > 1)
          for (t = 1; t < arguments.length; t++)
            (e = arguments[t]), i.connect(e);
        return this;
      }),
      (s.prototype.chain = function () {
        var t, e, i;
        if (arguments.length > 0)
          for (t = this, e = 0; e < arguments.length; e++)
            (i = arguments[e]), t.connect(i), (t = i);
        return this;
      }),
      ...
      (AudioNode.prototype.chain = s.prototype.chain),
      (AudioNode.prototype.fan = s.prototype.fan),
      (s.prototype.defaultArg = function (e, i) {
        var s, n, o;
      ...
      (s.prototype.isUndef = t),
      (s.prototype.isFunction = e),
      ...
      (s.State = { Started: "started", Stopped: "stopped", Paused: "paused" }),
      ...
      (s.startMobile = function () {
        var t,
          e = s.context.createOscillator(),
          i = s.context.createGain();
        (i.gain.value = 0),
          e.connect(i),
          i.connect(s.context.destination),
          (t = s.context.currentTime),
          e.start(t),
          e.stop(t + 1);
      }),
      s._initAudioContext(function (t) {
        (s.prototype.blockTime = 128 / t.sampleRate),
          (n = t.createGain()),
          (n.gain.value = 0),
    ...
    Module(function (t) {
      return (
        ...
        (t.SignalBase.prototype.connect = function (e, i, s) {
          return (
            ...
            t.prototype.connect.call(this, e, i, s),
            this
          );
        }),
        t.SignalBase
    ...
    Module(function (t) {
      return (
        ...
        (t.WaveShaper.prototype.setMap = function (t) {
          var e, i, s;
          for (e = 0, i = this._curve.length; i > e; e++)
            (s = (e / i) * 2 - 1), (this._curve[e] = t(s, e));
    ...
    Module(function (Tone) {
      function getTransportBpm() {
        return Tone.Transport && Tone.Transport.bpm
          ? Tone.Transport.bpm.value
          : 120;
      }
      function getTransportTimeSignature() {
        return Tone.Transport && Tone.Transport.timeSignature
      ...
      function toNotationHelper(t, e, i, s) {
        ...
        for (n = 0; n < s.length; n++)
          if (
            ((o = this.notationToSeconds(s[n], e, i)),
            (r = l / o),
            (a = 1e-6),
            a > 1 - (r % 1) && (r += a),
            (r = Math.floor(r)),
      ...
      return (
        ...
        (Tone.prototype.notationToSeconds = function (t, e, i) {
          ...
          return (
            ...
            (i = this.defaultArg(i, getTransportTimeSignature())),
            (s = 60 / e),
            "1n" === t && (t = "1m"),
            (n = parseInt(t, 10)),
            (o = 0),
        ...
        (Tone.prototype.transportTimeToSeconds = function (t, e, i) {
          ...
          return (
            ...
            (r = t.split(":")),
            2 === r.length
              ? ((s = parseFloat(r[0])), (n = parseFloat(r[1])))
              : 1 === r.length
              ? (n = parseFloat(r[0]))
              : 3 === r.length &&
                ((s = parseFloat(r[0])),
        ...
        (Tone.prototype.toFrequency = function (t, e) {
          return this.isFrequency(t)
            ? parseFloat(t)
            : this.isNotation(t) || this.isTransportTime(t)
            ? this.secondsToFrequency(this.toSeconds(t, e))
            : this.isNote(t)
            ? this.noteToFrequency(t)
            : t;
        }),
        (Tone.prototype.toTicks = function (t) {
          var e, i, s, n, o, r;
          if (this.isUndef(Tone.Transport)) return 0;
          if (((e = Tone.Transport.bpm.value), (i = 0), this.isNowRelative(t)))
            (t = t.replace("+", "")), (i = Tone.Transport.ticks);
          else if (this.isUndef(t)) return Tone.Transport.ticks;
          return (
            (s = this.toSeconds(t)),
            (n = 60 / e),
            (o = s / n),
            (r = o * Tone.Transport.PPQ),
            Math.round(r + i)
          );
        }),
        ...
        (Tone.prototype.toSeconds = function (time, now) {
          var plusTime,
            ...
            symb,
            val;
          if (((now = this.defaultArg(now, this.now())), this.isNumber(time)))
            return time;
          if (this.isString(time)) {
            if (
              ((plusTime = 0),
              this.isNowRelative(time) &&
                ((time = time.replace("+", "")), (plusTime = now)),
              (betweenParens = time.match(/\(([^)(]+)\)/g)))
            )
              for (j = 0; j < betweenParens.length; j++)
                (symbol = betweenParens[j].replace(/[\(\)]/g, "")),
                  (symbolVal = this.toSeconds(symbol)),
                  (time = time.replace(betweenParens[j], symbolVal));
            if (-1 !== time.indexOf("@")) {
              if (
                ((quantizationSplit = time.split("@")),
                this.isUndef(Tone.Transport))
              )
                throw new Error("quantization requires Tone.Transport");
              (toQuantize = quantizationSplit[0].trim()),
                "" === toQuantize && (toQuantize = void 0),
                plusTime > 0 &&
                  ((toQuantize = "+" + toQuantize), (plusTime = 0)),
                (subdivision = quantizationSplit[1].trim()),
                (time = Tone.Transport.quantize(toQuantize, subdivision));
            } else if (
              ((components = time.split(/[\(\)\-\+\/\*]/)),
              components.length > 1)
            ) {
              for (originalTime = time, i = 0; i < components.length; i++)
                (symb = components[i].trim()),
                  "" !== symb &&
                    ((val = this.toSeconds(symb)),
              ...
              time = this.isNotation(time)
                ? this.notationToSeconds(time)
                : this.isTransportTime(time)
                ? this.transportTimeToSeconds(time)
                : this.isFrequency(time)
                ? this.frequencyToSeconds(time)
                : this.isTicks(time)
                ? this.ticksToSeconds(time)
                : parseFloat(time);
        ...
        (Tone.prototype.noteToFrequency = function (t) {
          var e,
            ...
            n = t.split(/(-?\d+)/);
          return 3 === n.length
            ? ((e = noteToScaleIndex[n[0].toLowerCase()]),
              (i = n[1]),
              (s = e + 12 * (parseInt(i, 10) + 1)),
              this.midiToFrequency(s))
            : 0;
        }),
        (Tone.prototype.frequencyToNote = function (t) {
          var e,
            i = Math.log(t / Tone.A4) / Math.LN2,
            s = Math.round(12 * i) + 57,
            n = Math.floor(s / 12);
          return (
            0 > n && (s += -12 * n),
            (e = scaleIndexToNote[s % 12]),
            e + n.toString()
          );
        }),
        ...
        (Tone.prototype.noteToMidi = function (t) {
          var e,
            ...
            s = t.split(/(\d+)/);
          return 3 === s.length
            ? ((e = noteToScaleIndex[s[0].toLowerCase()]),
              (i = s[1]),
              e + 12 * (parseInt(i, 10) + 1))
            : 0;
        }),
      ...
      return (
        ...
        (t.Param.prototype.exponentialRampToValue = function (t, e) {
          var i = this.now(),
            s = this.value;
          return (
            this.setValueAtTime(Math.max(s, this._minOutput), i),
        ...
        (t.Param.prototype.rampTo = function (e, i) {
          return (
            ...
            this.units === t.Type.Frequency || this.units === t.Type.BPM
              ? this.exponentialRampToValue(e, i)
              : this.linearRampToValue(e, i),
            this
          );
        }),
    ...
    Module(function (t) {
      return (
        ...
        t._initAudioContext(function (e) {
          var i,
            s = e.createBuffer(1, 128, e.sampleRate),
    ...
    Module(function (t) {
      return (
        ...
        (t.Timeline.prototype.addEvent = function (t) {
          ...
          return (
            (t.time = this.toSeconds(t.time)),
            this._timeline.length
              ? ((e = this._search(t.time)), this._timeline.splice(e + 1, 0, t))
              : this._timeline.push(t),
            this.length > this.memory &&
              ((i = this.length - this.memory), this._timeline.splice(0, i)),
            this
          );
        }),
        ...
        (t.Timeline.prototype._search = function (t) {
          for (
            var e, i, s, n, o = 0, r = this._timeline.length, a = r;
            a >= o && r > o;

          ) {
            if (
              ((e = Math.floor(o + (a - o) / 2)),
              (i = this._timeline[e]),
              i.time === t)
            ) {
              for (s = e; s < this._timeline.length; s++)
                (n = this._timeline[s]), n.time === t && (e = s);
              return e;
            }
        ...
        (t.Timeline.prototype._iterate = function (t, e, i) {
          ...
          if (((this._iterating = !1), this._toRemove.length > 0)) {
            for (n = 0; n < this._toRemove.length; n++)
              (o = this._timeline.indexOf(this._toRemove[n])),
      ...
      return (
        ...
        (t.TimelineSignal.prototype.setTargetAtTime = function (e, i, s) {
          return (
            ...
            this._param.setTargetAtTime(e, i, s),
            this
          );
        }),
        ...
        (t.TimelineSignal.prototype.setRampPoint = function (e) {
          ...
          return (
            ...
            (s = this._searchAfter(e)),
            s &&
              (this.cancelScheduledValues(e),
              s.type === t.TimelineSignal.Type.Linear
                ? this.linearRampToValueAtTime(i, e)
                : s.type === t.TimelineSignal.Type.Exponential &&
        ...
        (t.TimelineSignal.prototype.getValueAtTime = function (e) {
          ...
          return (
            null === o
              ? (r = this._initial)
              : o.type === t.TimelineSignal.Type.Target
              ? ((i = this._events.getEventBefore(o.time)),
                (s = null === i ? this._initial : i.value),
              ...
              : (r =
                  null === n
                    ? o.value
                    : n.type === t.TimelineSignal.Type.Linear
                    ...
                    : n.type === t.TimelineSignal.Type.Exponential
      ...
      return (
        (t.Envelope = function () {
          ...
          (this.attack = e.attack),
            ...
            (this._attackCurve = t.Envelope.Type.Linear),
            (this._releaseCurve = t.Envelope.Type.Exponential),
            (this._minOutput = 1e-5),
        ...
        (t.Envelope.prototype._timeMult = 0.25),
        ...
        Object.defineProperty(t.Envelope.prototype, "attackCurve", {
          ...
          set: function (e) {
            if (
              e !== t.Envelope.Type.Linear &&
              e !== t.Envelope.Type.Exponential
            )
              throw Error(
        ...
        (t.Envelope.prototype.triggerAttack = function (e, i) {
          var s,
            n,
            o = this.now() + this.blockTime;
          return (
            (e = this.toSeconds(e, o)),
            (s = this.toSeconds(this.attack) + e),
            (n = this.toSeconds(this.decay)),
            (i = this.defaultArg(i, 1)),
            this._attackCurve === t.Envelope.Type.Linear
              ? this._sig.linearRampToValueBetween(i, e, s)
              : this._sig.exponentialRampToValueBetween(i, e, s),
            this._sig.setValueAtTime(i, s),
            this._sig.exponentialRampToValueAtTime(this.sustain * i, s + n),
            this
          );
        }),
        (t.Envelope.prototype.triggerRelease = function (e) {
          var i,
            s = this.now() + this.blockTime;
          return (
            (e = this.toSeconds(e, s)),
            (i = this.toSeconds(this.release)),
            this._releaseCurve === t.Envelope.Type.Linear
              ? this._sig.linearRampToValueBetween(this._minOutput, e, e + i)
        ...
        (t.Envelope.Type = { Linear: "linear", Exponential: "exponential" }),
        t.Envelope
      );
    }),
    Module(function (t) {
    ...
    Module(function (t) {
      return (
        ...
        Object.defineProperty(t.Analyser.prototype, "returnType", {
          ...
          set: function (e) {
            if (e === t.Analyser.ReturnType.Byte)
              this._buffer = new Uint8Array(this._analyser.frequencyBinCount);
            else {
              if (e !== t.Analyser.ReturnType.Float)
                throw new Error("Invalid Return Type: " + e);
    ...
    Module(function (t) {
      return (
        ...
        t.extend(t.EqualZero, t.SignalBase),
        (t.EqualZero.prototype.dispose = function () {
          return (
            t.prototype.dispose.call(this),
            this._gtz.dispose(),
            (this._gtz = null),
    ...
    Module(function (t) {
      return (
        (t.Equal = function (e) {
          t.call(this, 2, 0),
            (this._sub = this.input[0] = new t.Subtract(e)),
            (this._equals = this.output = new t.EqualZero()),
            this._sub.connect(this._equals),
            (this.input[1] = this._sub.input[1]);
        }),
        t.extend(t.Equal, t.SignalBase),
        Object.defineProperty(t.Equal.prototype, "value", {
          get: function () {
    ...
    Module(function (t) {
      (t.Select = function (i) {
        var s, n;
        for (
          i = this.defaultArg(i, 2),
            t.call(this, i, 1),
            this.gate = new t.Signal(0),
            this._readOnly("gate"),
            s = 0;
          i > s;
          s++
          ...
          (n = new e(s)),
            (this.input[s] = n),
            this.gate.connect(n.selecter),
            n.connect(this.output);
      }),
        t.extend(t.Select, t.SignalBase),
        (t.Select.prototype.select = function (t, e) {
          return (
            (t = Math.floor(t)),
            this.gate.setValueAtTime(t, this.toSeconds(e)),
            this
          );
        }),
        (t.Select.prototype.dispose = function () {
          ...
          for (var e = 0; e < this.input.length; e++)
            this.input[e].dispose(), (this.input[e] = null);
          return t.prototype.dispose.call(this), this;
        });
      var e = function (e) {
        (this.selecter = new t.Equal(e)),
    ...
    Module(function (t) {
      return (
        (t.IfThenElse = function () {
          t.call(this, 3, 0),
            (this._selector = this.output = new t.Select(2)),
        ...
        t.extend(t.IfThenElse, t.SignalBase),
        (t.IfThenElse.prototype.dispose = function () {
          return (
            t.prototype.dispose.call(this),
    ...
    Module(function (t) {
      return (
        ...
        t.extend(t.OR, t.SignalBase),
        (t.OR.prototype.dispose = function () {
          return (
            t.prototype.dispose.call(this),
            this._gtz.dispose(),
            (this._gtz = null),
    ...
    Module(function (t) {
      return (
        (t.AND = function (e) {
          (e = this.defaultArg(e, 2)),
            t.call(this, e, 0),
            (this._equals = this.output = new t.Equal(e));
          for (var i = 0; e > i; i++) this.input[i] = this._equals;
        }),
        t.extend(t.AND, t.SignalBase),
        (t.AND.prototype.dispose = function () {
          return (
            t.prototype.dispose.call(this),
            this._equals.dispose(),
            (this._equals = null),
    ...
    Module(function (t) {
      return (
        (t.LessThan = function (e) {
          t.call(this, 2, 0),
            (this._neg = this.input[0] = new t.Negate()),
            (this._gt = this.output = new t.GreaterThan()),
            (this._rhNeg = new t.Negate()),
            (this._param = this.input[1] = new t.Signal(e)),
            this._neg.connect(this._gt),
            this._param.connect(this._rhNeg),
            this._rhNeg.connect(this._gt, 0, 1);
        }),
        t.extend(t.LessThan, t.Signal),
        (t.LessThan.prototype.dispose = function () {
          return (
            t.prototype.dispose.call(this),
            this._neg.dispose(),
            (this._neg = null),
    ...
    Module(function (t) {
      return (
        (t.Abs = function () {
          t.call(this, 1, 0),
            (this._ltz = new t.LessThan(0)),
            (this._switch = this.output = new t.Select(2)),
            (this._negate = new t.Negate()),
      ...
      return (
        (t.Max = function (e) {
          t.call(this, 2, 0),
            ...
            (this._param = this.input[1] = new t.Signal(e)),
            (this._ifThenElse = this.output = new t.IfThenElse()),
            (this._gt = new t.GreaterThan()),
        ...
        t.extend(t.Max, t.Signal),
        (t.Max.prototype.dispose = function () {
          return (
            t.prototype.dispose.call(this),
            this._param.dispose(),
    ...
    Module(function (t) {
      return (
        ...
        t.extend(t.Min, t.Signal),
        (t.Min.prototype.dispose = function () {
          return (
            t.prototype.dispose.call(this),
            this._param.dispose(),
            this._ifThenElse.dispose(),
    ...
    Module(function (t) {
      function e(t, e, i) {
        var s = new t();
        return (
          i._eval(e[0]).connect(s, 0, 0), i._eval(e[1]).connect(s, 0, 1), s
        );
      }
      function i(t, e, i) {
        var s = new t();
      ...
      return (
        (t.Expr = function () {
          var t,
            e,
            i,
            s = this._replacements(Array.prototype.slice.call(arguments)),
            n = this._parseInputs(s);
          for (this._nodes = [], this.input = new Array(n), t = 0; n > t; t++)
            this.input[t] = this.context.createGain();
          e = this._parseTree(s);
          try {
            i = this._eval(e);
          } catch (o) {
            throw (
              (this._disposeNodes(),
              new Error("Could evaluate expression: " + s))
            );
          }
          this.output = i;
        }),
        ...
        (t.Expr._Expressions = {
          ...
          func: {
            ...
            min: { regexp: /^min/, method: e.bind(this, t.Min) },
            max: { regexp: /^max/, method: e.bind(this, t.Max) },
            if: {
              regexp: /^if/,
              method: function (e, i) {
                var s = new t.IfThenElse();
                return (
                  i._eval(e[0]).connect(s["if"]),
                  i._eval(e[1]).connect(s.then),
                  i._eval(e[2]).connect(s["else"]),
                  s
                );
              },
            },
            gt0: { regexp: /^gt0/, method: i.bind(this, t.GreaterThanZero) },
            eq0: { regexp: /^eq0/, method: i.bind(this, t.EqualZero) },
            mod: {
              regexp: /^mod/,
              method: function (e, i) {
                var s = n(e[1]),
          ...
          binary: {
            ...
            "&&": { regexp: /^&&/, precedence: 4, method: e.bind(this, t.AND) },
            "||": {
              regexp: /^\|\|/,
              precedence: 5,
        ...
        (t.Expr.prototype._parseInputs = function (t) {
          ...
          if (null !== s)
            for (e = 0; e < s.length; e++)
              (i = parseInt(s[e].substr(1)) + 1), (n = Math.max(n, i));
          return n;
        }),
        ...
        (t.Expr.prototype._tokenize = function (e) {
          function i(e) {
            ...
            for (i in t.Expr._Expressions) {
              ...
              for (n in s)
                if (((o = s[n]), (r = o.regexp), (a = e.match(r)), null !== a))
                  return { type: i, value: a[0], method: o.method };
            }
            throw new SyntaxError("Unexpected token " + e);
          }
          for (var s, n = -1, o = []; e.length > 0; )
            (e = e.trim()),
              (s = i(e)),
              o.push(s),
              (e = e.substr(s.value.length));
          return {
            next: function () {
              return o[++n];
            },
        ...
        (t.Expr.prototype._parseTree = function (e) {
          ...
          function s(e, i, s) {
            ...
            if (!u(e))
              for (n in a)
                if (((o = a[n]), o.regexp.test(e.value))) {
                  if (u(s)) return !0;
          ...
          function n(t) {
            var e, i;
            for (
              u(t) && (t = 5), e = 0 > t ? o() : n(t - 1), i = h.peek();
              s(i, "binary", t);

            )
              (i = h.next()),
                (e = { operator: i.value, method: i.method, args: [e, n(t)] }),
                (i = h.peek());
            return e;
          }
          function o() {
          ...
          function r() {
            ...
            if ("value" === t.type)
              return (t = h.next()), { method: t.method, args: t.value };
            if (i(t, "(")) {
              if ((h.next(), (e = n()), (t = h.next()), !i(t, ")")))
          ...
          function a(t) {
            ...
            if (((e = h.next()), !i(e, "(")))
              throw new SyntaxError(
                'Expected ( in a function call "' + t.value + '"'
              );
            if (
              ((e = h.peek()),
              i(e, ")") || (s = l()),
            ...
            return { method: t.method, args: s, name: name };
          }
          function l() {
            for (var t, e, s = []; ; ) {
              if (((e = n()), u(e))) break;
      ...
      return (
        ...
        Object.defineProperty(t.Filter.prototype, "type", {
          ...
          set: function (t) {
            ...
            if (-1 === i.indexOf(t))
              throw new Error("Tone.Filter does not have filter type " + t);
        ...
        Object.defineProperty(t.Filter.prototype, "rolloff", {
          ...
          set: function (t) {
            ...
            if (
              ...
              throw new Error(
                "Filter rolloff can only be -12, -24, -48 or -96"
              );
            for (
              i += 1, this._rolloff = t, this.input.disconnect(), s = 0;
              s < this._filters.length;
              s++
            )
              this._filters[s].disconnect(), (this._filters[s] = null);
            for (this._filters = new Array(i), n = 0; i > n; n++)
              (o = this.context.createBiquadFilter()),
                ...
                (this._filters[n] = o);
            (r = [this.input].concat(this._filters).concat([this.output])),
              this.connectSeries.apply(this, r);
          },
        }),
    ...
    Module(function (t) {
      return (
        (t.ScaleExp = function (e, i, s) {
          (this._scale = this.output = new t.Scale(e, i)),
            (this._exp = this.input = new t.Pow(this.defaultArg(s, 2))),
    ...
    Module(function (t) {
      return (
        ...
        (t.Follower.prototype._setAttackRelease = function (t, e) {
          ...
          (t = this.secondsToFrequency(this.toSeconds(t))),
            (e = this.secondsToFrequency(this.toSeconds(e))),
            (t = Math.max(t, i)),
            (e = Math.max(e, i)),
            this._frequencyValues.setMap(function (i) {
              return 0 >= i ? t : e;
            });
        }),
      ...
      return (
        (t.FrequencyEnvelope = function () {
          ...
          t.ScaledEnvelope.call(this, e),
            (e = this.defaultArg(e, t.FrequencyEnvelope.defaults)),
    ...
    Module(function (t) {
      return (
        ...
        (t.TimelineState.prototype.setStateAtTime = function (t, e) {
          this.addEvent({ state: t, time: this.toSeconds(e) });
        }),
        t.TimelineState
      );
    }),
    Module(function (t) {
      return (
        ...
        (t.Clock.prototype.start = function (e, i) {
          return (
            (e = this.toSeconds(e)),
            this._state.getStateAtTime(e) !== t.State.Started &&
        ...
        (t.Clock.prototype.stop = function (e) {
          return (
            (e = this.toSeconds(e)),
            this._state.getStateAtTime(e) !== t.State.Stopped &&
        ...
        (t.Clock.prototype._loop = function (e) {
          ...
          if (
            ...
            "auto" === this._lookAhead
              ? this.isUndef(e) ||
                ((i = (e - this._lastUpdate) / 1e3),
                (this._lastUpdate = e),
                i < this._threshold &&
                  (this._computedLookAhead =
                    (9 * this._computedLookAhead + i) / 10))
              : (this._computedLookAhead = this._lookAhead),
            (s = this.now()),
            (n = 2 * this._computedLookAhead),
            (o = this._state.getEvent(s + n)),
            (r = t.State.Stopped),
            o &&
              ((r = o.state),
              -1 === this._nextTick &&
            ...
            for (; s + n > this._nextTick; )
              s > this._nextTick + this._threshold && (this._nextTick = s),
                (a = this._nextTick),
                (this._nextTick +=
            ...
            r === t.State.Stopped && ((this._nextTick = -1), (this.ticks = 0));
        }),
      ...
      return (
          ...
          for (s = 0; s < r.length; s++)
            if (((e = r[s]), this._events.hasOwnProperty(e)))
              if (t.prototype.isUndef(i)) this._events[e] = [];
                ...
                for (n = this._events[e], o = 0; o < n.length; o++)
                  n[o] === i && n.splice(o, 1);
          return this;
        }),
        (t.Emitter.prototype.trigger = function (t) {
          ...
          if (
            ...
            for (i = this._events[t], s = 0, n = i.length; n > s; s++)
              i[s].apply(this, e);
          return this;
        }),
        (t.Emitter.mixin = function (e) {
          ...
          for (e._events = {}, i = 0; i < o.length; i++)
            (s = o[i]), (n = t.Emitter.prototype[s]), (e[s] = n);
        }),
    ...
    Module(function (t) {
      (t.IntervalTimeline = function () {
        ...
        (t.IntervalTimeline.prototype.addEvent = function (t) {
          if (this.isUndef(t.time) || this.isUndef(t.duration))
            throw new Error("events must have time and duration parameters");
          var i = new e(t.time, t.time + t.duration, t);
          for (
            null === this._root ? (this._root = i) : this._root.insert(i),
              this._length++;
            null !== i;

          )
            i.updateHeight(), i.updateMax(), this._rebalance(i), (i = i.parent);
          return this;
        }),
        ...
        (t.IntervalTimeline.prototype.forEachOverlap = function (t, e) {
          var i, s, n;
          if (((t = this.toSeconds(t)), null !== this._root))
            for (i = [], this._root.search(t, i), s = i.length - 1; s >= 0; s--)
              (n = i[s].event), n && e(n);
          return this;
        }),
        (t.IntervalTimeline.prototype.forEachAfter = function (t, e) {
          ...
          if (((t = this.toSeconds(t)), null !== this._root))
            for (
              i = [], this._root.searchAfter(t, i), s = i.length - 1;
              s >= 0;
              s--
            )
              (n = i[s].event), n && e(n);
    ...
    Module(function (t) {
      (t.Transport = function () {
        t.Emitter.call(this),
          ...
          (this._syncedSignals = []);
        var i = this.notationToSeconds(
          e.defaults.swingSubdivision,
          e.defaults.bpm,
          e.defaults.timeSignature
        );
        (this._swingTicks = (i / (60 / e.defaults.bpm)) * this._ppq),
          (this._swingAmount = 0);
      }),
        ...
        (t.Transport.prototype._processTick = function (t) {
          this._swingAmount > 0 &&
            this._clock.ticks % this._ppq !== 0 &&
            this._clock.ticks % this._swingTicks === 0 &&
            (t += this.ticksToSeconds(this._swingTicks) * this._swingAmount),
            this.loop &&
              this._clock.ticks === this._loopEnd &&
              ((this.ticks = this._loopStart), this.trigger("loop", t));
        ...
        (t.Transport.prototype.schedule = function (t, e) {
          var i = { time: this.toTicks(e), callback: t },
            s = this._eventID++;
          return (
            (this._scheduledEvents[s.toString()] = {
              event: i,
              timeline: this._timeline,
            }),
            this._timeline.addEvent(i),
            s
          );
        }),
        (t.Transport.prototype.scheduleRepeat = function (t, e, i, s) {
          ...
          if (0 >= e)
            throw new Error(
              "repeat events must have an interval larger than 0"
            );
          return (
            (n = {
              time: this.toTicks(i),
            ...
            (o = this._eventID++),
            (this._scheduledEvents[o.toString()] = {
              event: n,
              timeline: this._repeatedEvents,
            }),
            this._repeatedEvents.addEvent(n),
            o
          );
        }),
        ...
        (t.Transport.prototype.clear = function (t) {
          if (this._scheduledEvents.hasOwnProperty(t)) {
            ...
            e.timeline.removeEvent(e.event),
        ...
        (t.Transport.prototype.cancel = function (t) {
          return (
            ...
            (t = this.toTicks(t)),
            this._timeline.cancel(t),
            this._onceEvents.cancel(t),
            this._repeatedEvents.cancel(t),
            this
          );
        }),
        (t.Transport.prototype.quantize = function (e, i) {
          var s, n, o;
          return (
            (i = this.defaultArg(i, "4n")),
            (s = this.toTicks(e)),
            (i = this.toTicks(i)),
            (n = i - (s % i)),
            n === i && (n = 0),
            (o = this.now()),
            this.state === t.State.Started && (o = this._clock._nextTick),
            this.toSeconds(e, o) + this.ticksToSeconds(n)
          );
        }),
        ...
        (t.Transport.prototype.start = function (t, e) {
          return (
            (t = this.toSeconds(t)),
            (e = this.isUndef(e)
              ? this.defaultArg(e, this._clock.ticks)
              : this.toTicks(e)),
            this._clock.start(t, e),
            this.trigger("start", t, this.ticksToSeconds(e)),
            this
          );
        }),
        ...
        (t.Transport.prototype.setInterval = function (e, i) {
          return (
            ...
            t.Transport.scheduleRepeat(e, i)
          );
        }),
      ...
      return (
        (t.Source = function (e) {
          t.call(this),
            ...
            this._readOnly("volume"),
            (this._state = new t.TimelineState(t.State.Stopped)),
            (this._syncStart = function (t, e) {
              (t = this.toSeconds(t)),
                (t += this.toSeconds(this._startDelay)),
                this.start(t, e);
            }.bind(this)),
        ...
        (t.Source.prototype.sync = function (e) {
          return (
            (this._startDelay = this.defaultArg(e, 0)),
            t.Transport.on("start", this._syncStart),
            t.Transport.on("stop pause", this._syncStop),
            this
          );
        }),
        (t.Source.prototype.unsync = function () {
          return (
            (this._startDelay = 0),
            t.Transport.off("start", this._syncStart),
            t.Transport.off("stop pause", this._syncStop),
            this
          );
        }),
    ...
    Module(function (t) {
      return (
        ...
        (t.Oscillator.prototype._stop = function (t) {
          return (
            this._oscillator &&
              (this._oscillator.stop(this.toSeconds(t)),
              (this._oscillator = null)),
            this
          );
        }),
        ...
        (t.Oscillator.prototype._getRealImaginary = function (e, i) {
          ...
          for (
            e === t.Oscillator.Type.Custom
              ? ((c = this._partials.length + 1), (l = c))
              : ((s = /^(sine|triangle|square|sawtooth)(\d+)$/.exec(e)),
                s &&
                  ((c = parseInt(s[2]) + 1),
                  (e = s[1]),
                  (c = Math.max(c, 2)),
            ...
            0 !== r
              ? ((h[n] = -r * Math.sin(i * n)), (u[n] = r * Math.cos(i * n)))
              : ((h[n] = 0), (u[n] = 0));
          }
          return [h, u];
        }),
        (t.Oscillator.prototype._inverseFFT = function (t, e, i) {
          var s,
            ...
            o = t.length;
          for (s = 0; o > s; s++)
            n += t[s] * Math.cos(s * i) + e[s] * Math.sin(s * i);
          return n;
        }),
        (t.Oscillator.prototype._getInitialValue = function () {
          var t,
            ...
            o = 2 * Math.PI;
          for (t = 0; 8 > t; t++)
            n = Math.max(this._inverseFFT(i, s, (t / 8) * o), n);
    ...
    Module(function (t) {
      return (
        ...
        (t.LFO.prototype.sync = function (t) {
          return (
            this._oscillator.sync(t), this._oscillator.syncFrequency(), this
          );
        }),
      ...
      return (
        (t.Meter = function () {
          ...
          for (
            t.call(this),
              ...
              this.clipMemory = s.clipMemory,
              this.clipLevel = s.clipLevel,
            ...
            (this._volume[e] = 0), (this._values[e] = 0);
          for (
            this._lastClip = new Array(this._channels), i = 0;
            i < this._lastClip.length;
            i++
          )
            this._lastClip[i] = 0;
        ...
        (t.Meter.prototype._onprocess = function (t) {
          var e,
            ...
            a,
            l,
            h = this._jsNode.bufferSize,
            u = this.smoothing;
          for (e = 0; e < this._channels; e++) {
            for (
              i = t.inputBuffer.getChannelData(e), s = 0, n = 0, r = 0;
              h > r;
              r++
            )
              (o = i[r]), (n += o), (s += o * o);
            (a = n / h),
              (l = Math.sqrt(s / h)),
              l > 0.9 && (this._lastClip[e] = Date.now()),
              (this._volume[e] = Math.max(l, this._volume[e] * u)),
              (this._values[e] = a);
          }
        }),
        ...
        (t.Meter.prototype.isClipped = function (t) {
          return (
            (t = this.defaultArg(t, 0)),
            Date.now() - this._lastClip[t] < 1e3 * this._clipMemory
          );
        }),
    ...
    Module(function (t) {
      (t.MidSideSplit = function () {
        t.call(this, 0, 2),
          ...
          e.connect(this.mid, 0, 2),
          e.connect(this.side, 0, 2);
      }),
    ...
    Module(function (t) {
      (t.MidSideMerge = function () {
        t.call(this, 2, 0),
          ...
          e.connect(this._left, 0, 2),
          e.connect(this._right, 0, 2);
      }),
    ...
    Module(function (t) {
      return (
        (t.Panner = function (e) {
          t.call(this),
            (this._hasStereoPanner = this.isFunction(
            ...
            this._hasStereoPanner
              ? ((this._panner =
                  ...
                  this.output =
                    this.context.createStereoPanner()),
                (this.pan = new t.Signal(0, t.Type.NormalRange)),
                (this._scalePan = new t.GainToAudio()),
            ...
            (this.pan.value = this.defaultArg(e, 0.5)),
            this._readOnly("pan");
        }),
        t.extend(t.Panner),
        ...
        Object.defineProperty(t.CtrlInterpolate.prototype, "value", {
          get: function () {
            var t,
              ...
              s = this.index;
            return (
              (s = Math.min(s, this.values.length - 1)),
              (t = Math.floor(s)),
              (e = this.values[t]),
              (i = this.values[Math.ceil(s)]),
              this._interpolate(s - t, e, i)
            );
          },
        }),
        (t.CtrlInterpolate.prototype._interpolate = function (t, e, i) {
          ...
          if (this.isArray(e)) {
            for (s = [], n = 0; n < e.length; n++)
              s[n] = this._interpolate(t, e[n], i[n]);
            return s;
          }
          if (this.isObject(e)) {
            o = {};
    ...
    Module(function (t) {
      return (
        (t.CtrlMarkov = function (t, e) {
          (this.values = this.defaultArg(t, {})),
            (this.value = this.defaultArg(e, Object.keys(this.values)[0]));
        }),
            ...
            if (((t = this.values[this.value]), this.isArray(t)))
              for (
                ...
                (o = e[n]),
                  i > s &&
                    s + o > i &&
                    ((r = t[n]), (this.value = this.isObject(r) ? r.value : r)),
                  (s += o);
            else this.value = t;
          return this.value;
        }),
            ...
            e === t.CtrlPattern.Type.Up
              ...
              ? (this._direction === t.CtrlPattern.Type.Up
                  ...
                  : ((this.index -= 1),
                    (this._direction = t.CtrlPattern.Type.Up)),
                this.index >= this.values.length &&
                  ((this.index = 0), (this._direction = t.CtrlPattern.Type.Up)))
      ...
      return (
        (t.Buffer = function () {
          ...
          (this._buffer = null),
            ...
            (this.url = void 0),
            (this.loaded = !1),
            (this.onload = e.onload.bind(this, this)),
            e.url instanceof AudioBuffer || e.url instanceof t.Buffer
              ? (this.set(e.url), this.onload(this))
              : this.isString(e.url) &&
                ((this.url = e.url), t.Buffer._addToQueue(e.url, this));
        }),
        t.extend(t.Buffer),
        (t.Buffer.defaults = { url: void 0, onload: t.noOp, reverse: !1 }),
        (t.Buffer.prototype.set = function (e) {
          return (
            (this._buffer = e instanceof t.Buffer ? e.get() : e),
            (this.loaded = !0),
            this
          );
        }),
        ...
        (t.Buffer.prototype.load = function (e, i) {
          return (
            (this.url = e),
            (this.onload = this.defaultArg(i, this.onload)),
            t.Buffer._addToQueue(e, this),
            this
          );
        }),
        (t.Buffer.prototype.dispose = function () {
          return (
            t.prototype.dispose.call(this),
            t.Buffer._removeFromQueue(this),
            (this._buffer = null),
            (this.onload = t.Buffer.defaults.onload),
            this
          );
        }),
        ...
        (t.Buffer.prototype._reverse = function () {
          if (this.loaded)
            for (var t = 0; t < this._buffer.numberOfChannels; t++)
              Array.prototype.reverse.call(this._buffer.getChannelData(t));
          return this;
        }),
        ...
        (t.Buffer._totalDownloads = 0),
        (t.Buffer.MAX_SIMULTANEOUS_DOWNLOADS = 6),
        (t.Buffer._addToQueue = function (e, i) {
          t.Buffer._queue.push({ url: e, Buffer: i, progress: 0, xhr: null }),
            this._totalDownloads++,
            t.Buffer._next();
        }),
        (t.Buffer._removeFromQueue = function (e) {
          var i, s, n;
          for (i = 0; i < t.Buffer._queue.length; i++)
            (s = t.Buffer._queue[i]),
              s.Buffer === e && t.Buffer._queue.splice(i, 1);
          for (i = 0; i < t.Buffer._currentDownloads.length; i++)
            (n = t.Buffer._currentDownloads[i]),
              n.Buffer === e &&
                (t.Buffer._currentDownloads.splice(i, 1),
                n.xhr.abort(),
                (n.xhr.onprogress = null),
                (n.xhr.onload = null),
                (n.xhr.onerror = null));
        }),
        (t.Buffer._next = function () {
          if (t.Buffer._queue.length > 0) {
            if (
              t.Buffer._currentDownloads.length <
              t.Buffer.MAX_SIMULTANEOUS_DOWNLOADS
            ) {
              var e = t.Buffer._queue.shift();
              t.Buffer._currentDownloads.push(e),
                (e.xhr = t.Buffer.load(e.url, function (i) {
                  var s = t.Buffer._currentDownloads.indexOf(e);
                  t.Buffer._currentDownloads.splice(s, 1),
                    e.Buffer.set(i),
                    e.Buffer._reversed && e.Buffer._reverse(),
                    e.Buffer.onload(e.Buffer),
                    t.Buffer._onprogress(),
                    t.Buffer._next();
                })),
            ...
            0 === t.Buffer._currentDownloads.length &&
              (t.Buffer.trigger("load"), (t.Buffer._totalDownloads = 0));
        }),
        (t.Buffer._onprogress = function () {
          ...
          if (r > 0) {
            for (e = 0; r > e; e++)
              (i = t.Buffer._currentDownloads[e]), (o += i.progress);
            a = o;
          }
          (s = r - a),
            (n = t.Buffer._totalDownloads - t.Buffer._queue.length - s),
            t.Buffer.trigger("progress", n / t.Buffer._totalDownloads);
        }),
    ...
    Module(function (t) {
      ...
      return (
        (t.prototype.send = function (t, i) {
          ...
          return (
            (s.gain.value = this.dbToGain(this.defaultArg(i, 1))),
            this.output.chain(s, e[t]),
            s
          );
        }),
      ...
      return (
        (t.Delay = function () {
          ...
          (this._delayNode =
            this.input =
            this.output =
              this.context.createDelay(this.toSeconds(e.maxDelay))),
            (this.delayTime = new t.Param({
    ...
    Module(function (t) {
        ...
        Object.defineProperty(t.Master.prototype, "mute", {
          ...
          set: function (t) {
            !this._muted && t
              ...
              : this._muted && !t && (this.volume.value = this._unmutedVolume),
              (this._muted = t);
          },
        }),
      ...
      return (
        t._initAudioContext(function () {
          t.prototype.isUndef(t.Master)
            ? (e.prototype.dispose.call(t.Master), e.call(t.Master))
            : (t.Master = new e());
        }),
        t.Master
      );
    ...
    Module(function (t) {
      function e(t, e, s) {
        ...
        if (i.hasOwnProperty(t))
          for (n = i[t], o = 0, r = n.length; r > o; o++)
            (a = n[o]),
              Array.isArray(s) ? a.apply(window, [e].concat(s)) : a(e, s);
      }
      (t.Note = function (e, i, s) {
        (this.value = s),
          (this._channel = e),
          (this._timelineID = t.Transport.setTimeline(
        ...
        (t.Note.prototype.dispose = function () {
          return (
            t.Transport.clearTimeline(this._timelineID),
            (this.value = null),
            this
          );
        });
      var i = {};
      return (
        (t.Note.route = function (t, e) {
          i.hasOwnProperty(t) ? i[t].push(e) : (i[t] = [e]);
        }),
        (t.Note.unroute = function (t, e) {
          var s, n;
          i.hasOwnProperty(t) &&
            ((s = i[t]), (n = s.indexOf(e)), -1 !== n && i[t].splice(n, 1));
        }),
        (t.Note.parseScore = function (e) {
          ...
          for (i in e)
            if (((s = e[i]), "tempo" === i)) t.Transport.bpm.value = s;
            else if ("timeSignature" === i)
              t.Transport.timeSignature = s[0] / (s[1] / 4);
            else {
              if (!Array.isArray(s))
              ...
              for (n = 0; n < s.length; n++)
                (o = s[n]),
                  Array.isArray(o)
                    ? ((a = o[0]), (l = o.slice(1)), (r = new t.Note(i, a, l)))
                    : (r =
                        "object" == typeof o
                          ? new t.Note(i, o.time, o)
                          : new t.Note(i, o)),
                  h.push(r);
            }
          return h;
    ...
    Module(function (t) {
      return (
        (t.BitCrusher = function () {
          var e,
            i = this.optionsObject(arguments, ["bits"], t.BitCrusher.defaults);
      ...
      return (
        ...
        Object.defineProperty(t.Chebyshev.prototype, "order", {
          ...
          set: function (t) {
            var e, i, s, n;
            for (
              this._order = t, e = new Array(4096), i = e.length, s = 0;
              i > s;
              ++s
            )
              (n = (2 * s) / i - 1),
    ...
    Module(function (t) {
      return (
        ...
        (t.Convolver.defaults = { url: "", onload: t.noOp }),
      ...
      return (
        (t.Freeverb = function () {
          var s,
            ...
            a,
            l,
            h = this.optionsObject(
              arguments,
              ["roomSize", "dampening"],
              t.Freeverb.defaults
            );
          for (
            t.StereoEffect.call(this, h),
              this.roomSize = new t.Signal(h.roomSize, t.Type.NormalRange),
              this.dampening = new t.Signal(h.dampening, t.Type.Frequency),
              this._combFilters = [],
        ...
        (t.Freeverb.prototype.dispose = function () {
          ...
          for (
            this._allpassFiltersR = null, s = 0;
            s < this._combFilters.length;
            s++
          )
            this._combFilters[s].dispose(), (this._combFilters[s] = null);
          return (
        ...
        (t.JCReverb = function () {
          ...
          for (
            ...
            (o = this.context.createBiquadFilter()),
              ...
              this._allpassFilters.push(o);
          for (r = 0; r < e.length; r++)
            (a = new t.FeedbackCombFilter(e[r], 0.1)),
              this._scaleRoomSize.connect(a.resonance),
              (a.resonance.value = i[r]),
              this._allpassFilters[this._allpassFilters.length - 1].connect(a),
              a.connect(
                r < e.length / 2 ? this.effectReturnL : this.effectReturnR
              ),
    ...
    Module(function (t) {
      return (
        (t.PingPongDelay = function () {
          ...
          t.StereoXFeedbackEffect.call(this, e),
            (this._leftDelay = this.context.createDelay(e.maxDelayTime)),
            (this._rightDelay = this.context.createDelay(e.maxDelayTime)),
            (this._rightPreDelay = this.context.createDelay(e.maxDelayTime)),
            (this.delayTime = new t.Signal(e.delayTime, t.Type.Time)),
    ...
    Module(function (t) {
      return (
        (t.PitchShift = function () {
          var e,
            i = this.optionsObject(arguments, ["pitch"], t.PitchShift.defaults);
          ...
          set: function (t) {
            ...
            0 > t
              ? ((this._lfoA.min = 0),
                ...
                (e = this.intervalToFrequencyRatio(t - 1) + 1))
              : ((this._lfoA.min = this._windowSize),
                (this._lfoA.max = 0),
                (this._lfoB.min = this._windowSize),
                (this._lfoB.max = 0),
                (e = this.intervalToFrequencyRatio(t) - 1)),
      ...
      return (
            ...
            this._state.forEachFrom(
              ...
              function (e) {
                ...
                e.state === t.State.Started &&
                  ...
                  (s =
                    e.time + Math.round(this.startOffset / this._playbackRate)),
                  this._loop
                    ? ((i = 1 / 0),
                      this.isNumber(this._loop) &&
                        (i = (this._loop - 1) * this._getLoopDuration()),
                      (n = this._state.getEventAfter(s)),
                      null !== n && (i = Math.min(i, n.time - s)),
                      i !== 1 / 0 &&
                        (this._state.setStateAtTime(t.State.Stopped, s + i + 1),
                        (i += "i")),
        ...
        (t.Event.prototype.stop = function (e) {
          ...
          return (
            ...
            this._state.getStateAtTime(e) === t.State.Started &&
              (this._state.setStateAtTime(t.State.Stopped, e),
              (i = this._state.getEventBefore(e)),
              (s = e),
              null !== i && (s = i.time),
        ...
        (t.Event.prototype._tick = function (e) {
          if (
            !this.mute &&
            this._state.getStateAtTime(t.Transport.ticks) === t.State.Started
          ) {
        ...
        Object.defineProperty(t.Event.prototype, "progress", {
          get: function () {
            ...
            return this._loop
              ? ((e = t.Transport.ticks),
                (i = this._state.getEvent(e)),
                null !== i && i.state === t.State.Started
                  ? ((s = this._getLoopDuration()),
                    (n = (e - i.time) % s),
                    n / s)
                  : 0)
              : 0;
    ...
    Module(function (t) {
      return (
        (t.Part = function () {
          ...
          if (
            ((this._loop = s.loop),
            (this._loopStart = this.toTicks(s.loopStart)),
            (this._loopEnd = this.toTicks(s.loopEnd)),
            (this._playbackRate = s.playbackRate),
            (this._probability = s.probability),
            (this._humanize = s.humanize),
            (this._startOffset = 0),
            (this._state = new t.TimelineState(t.State.Stopped)),
            (this._events = []),
            (this.callback = s.callback),
            (this.mute = s.mute),
            (e = this.defaultArg(s.events, [])),
            !this.isUndef(s.events))
          )
            for (i = 0; i < e.length; i++)
              Array.isArray(e[i]) ? this.add(e[i][0], e[i][1]) : this.add(e[i]);
        }),
        ...
        (t.Part.prototype.start = function (e, i) {
          ...
          return (
            this._state.getStateAtTime(s) !== t.State.Started &&
              ((i = this.defaultArg(i, 0)),
              (i = this.toTicks(i)),
              this._state.addEvent({
                state: t.State.Started,
        ...
        (t.Part.prototype.stop = function (e) {
          ...
          return (
            this._state.getStateAtTime(i) === t.State.Started &&
        ...
        (t.Part.prototype.at = function (t, e) {
          var i, s, n;
          for (
            t = this.toTicks(t), i = this.ticksToSeconds(1), s = 0;
            s < this._events.length;
            s++
          )
            if (((n = this._events[s]), Math.abs(t - n.startOffset) < i))
              return this.isUndef(e) || (n.value = e), n;
          return this.isUndef(e)
            ? null
            : (this.add(t + "i", e), this._events[this._events.length - 1]);
        }),
        (t.Part.prototype.add = function (e, i) {
          this.isObject(e) &&
            e.hasOwnProperty("time") &&
            ((i = e), (e = i.time), delete i.time),
            (e = this.toTicks(e));
          var s;
          return (
            i instanceof t.Event
              ? ((s = i), (s.callback = this._tick.bind(this)))
              : (s = new t.Event({
                  callback: this._tick.bind(this),
                  value: i,
                })),
          ...
          for (
            ...
            (n = this._events[s]),
              n instanceof t.Part
                ? n.remove(e, i)
                : n.startOffset === e &&
                  (this.isUndef(i) || (!this.isUndef(i) && n.value === i)) &&
                  (this._events.splice(s, 1), n.dispose());
          return this;
        }),
        ...
        (t.Part.prototype._forEach = function (e, i) {
          var s, n;
          for (
            i = this.defaultArg(i, this), s = this._events.length - 1;
            s >= 0;
            s--
          )
            (n = this._events[s]),
              n instanceof t.Part ? n._forEach(e, i) : e.call(i, n);
          return this;
        }),
    ...
    Module(function (t) {
      return (
        ...
        (t.Pattern.defaults = { pattern: t.CtrlPattern.Type.Up, events: [] }),
      ...
      return (
        (t.Sequence = function () {
          ...
          if (
            ...
            this.isUndef(i.loopEnd) &&
              !this.isUndef(s) &&
              (this._loopEnd = s.length * this._subdivision),
            (this._loop = !0),
            !this.isUndef(s))
          )
            for (e = 0; e < s.length; e++) this.add(e, s[e]);
        }),
        ...
        (t.Sequence.prototype._indexTime = function (t) {
          return this.isTicks(t)
            ? t
            : t * this._subdivision + this.startOffset + "i";
        }),
      ...
      return (
        (t.PWMOscillator = function () {
          ...
          t.Source.call(this, e),
            ...
            (this._scale = new t.Multiply(1.01)),
    ...
    Module(function (t) {
      (t.OmniOscillator = function () {
        ...
        t.Source.call(this, e),
          ...
          (this.phase = e.phase),
          this._readOnly(["frequency", "detune"]),
          this.isArray(e.partials) && (this.partials = e.partials);
      }),
      ...
      return (
        ...
        Object.defineProperty(t.OmniOscillator.prototype, "type", {
          ...
          set: function (i) {
            if (
              0 === i.indexOf("sine") ||
              0 === i.indexOf("square") ||
              0 === i.indexOf("triangle") ||
              0 === i.indexOf("sawtooth") ||
              i === t.Oscillator.Type.Custom
            )
              this._sourceType !== e.Oscillator &&
                ((this._sourceType = e.Oscillator),
                this._createNewOscillator(t.Oscillator)),
                (this._oscillator.type = i);
            else if ("pwm" === i)
              this._sourceType !== e.PWMOscillator &&
                ((this._sourceType = e.PWMOscillator),
                this._createNewOscillator(t.PWMOscillator));
            else {
              if ("pulse" !== i)
                throw new Error(
                  "Tone.OmniOscillator does not support type " + i
                );
              this._sourceType !== e.PulseOscillator &&
                ((this._sourceType = e.PulseOscillator),
                this._createNewOscillator(t.PulseOscillator));
            }
          },
        }),
        ...
        (t.OmniOscillator.prototype._createNewOscillator = function (e) {
          ...
          null !== this._oscillator &&
            ...
            this.detune.connect(this._oscillator.detune),
            this._oscillator.connect(this.output),
            this.state === t.State.Started && this._oscillator.start(s);
        }),
        ...
        Object.defineProperty(t.OmniOscillator.prototype, "width", {
          get: function () {
            return this._sourceType === e.PulseOscillator
        ...
        Object.defineProperty(
          ...
          {
            get: function () {
              return this._sourceType === e.PWMOscillator
    ...
    Module(function (t) {
      return (
        (t.Instrument = function (e) {
          (e = this.defaultArg(e, t.Instrument.defaults)),
            (this._volume = this.output = new t.Volume(e.volume)),
            (this.volume = this._volume.volume),
            this._readOnly("volume");
        }),
        ...
        (t.Instrument.prototype.triggerAttackRelease = function (t, e, i, s) {
          return (
            (i = this.toSeconds(i)),
            (e = this.toSeconds(e)),
    ...
    Module(function (t) {
      return (
        (t.Monophonic = function (e) {
          (e = this.defaultArg(e, t.Monophonic.defaults)),
          ...
          return (
            ...
            this.portamento > 0
              ? ((i = this.frequency.value),
                ...
                (s = this.toSeconds(this.portamento)),
                this.frequency.exponentialRampToValueAtTime(t, e + s))
      ...
      return (
        (t.AMSynth = function (e) {
          (e = this.defaultArg(e, t.AMSynth.defaults)),
            t.Monophonic.call(this, e),
            (this.carrier = new t.MonoSynth(e.carrier)),
            (this.carrier.volume.value = -10),
            (this.modulator = new t.MonoSynth(e.modulator)),
        ...
        (t.AMSynth.prototype._triggerEnvelopeAttack = function (t, e) {
          return (
            (t = this.toSeconds(t)),
            this.carrier.envelope.triggerAttack(t, e),
            this.modulator.envelope.triggerAttack(t),
            this.carrier.filterEnvelope.triggerAttack(t),
            this.modulator.filterEnvelope.triggerAttack(t),
            this
          );
        }),
        (t.AMSynth.prototype._triggerEnvelopeRelease = function (t) {
          return (
            this.carrier.triggerRelease(t),
            this.modulator.triggerRelease(t),
            this
          );
        }),
    ...
    Module(function (t) {
      return (
        (t.DrumSynth = function (e) {
          (e = this.defaultArg(e, t.DrumSynth.defaults)),
            t.Instrument.call(this, e),
            (this.oscillator = new t.Oscillator(e.oscillator).start()),
            (this.envelope = new t.AmplitudeEnvelope(e.envelope)),
            (this.octaves = e.octaves),
        ...
        t.extend(t.DrumSynth, t.Instrument),
        (t.DrumSynth.defaults = {
          pitchDecay: 0.05,
          octaves: 10,
          oscillator: { type: "sine" },
          envelope: {
      ...
      return (
        (t.DuoSynth = function (e) {
          (e = this.defaultArg(e, t.DuoSynth.defaults)),
            ...
            (this.vibratoAmount = new t.Param({
        ...
        (t.DuoSynth.prototype._triggerEnvelopeRelease = function (t) {
          return (
            this.voice0.triggerRelease(t), this.voice1.triggerRelease(t), this
          );
        }),
    ...
    Module(function (t) {
      (t.Noise = function () {
        ...
        (t.Noise.prototype._start = function (t) {
          (this._source = this.context.createBufferSource()),
            ...
            this._source.start(this.toSeconds(t));
        }),
      ...
      var e = null,
        ...
        s = null;
      return (
        t._initAudioContext(function (t) {
          var n = t.sampleRate,
            o = 4 * n;
          (e = (function () {
            var e,
              ...
              p,
              f,
              d = t.createBuffer(2, o, n);
            for (e = 0; e < d.numberOfChannels; e++)
              for (
                i = d.getChannelData(e), s = r = a = l = h = u = c = 0, p = 0;
                o > p;
                p++
              )
                (f = 2 * Math.random() - 1),
                  (s = 0.99886 * s + 0.0555179 * f),
                  (r = 0.99332 * r + 0.0750759 * f),
                  (a = 0.969 * a + 0.153852 * f),
                  (l = 0.8665 * l + 0.3104856 * f),
                  (h = 0.55 * h + 0.5329522 * f),
                  (u = -0.7616 * u - 0.016898 * f),
                  (i[p] = s + r + a + l + h + u + c + 0.5362 * f),
                  (i[p] *= 0.11),
                  (c = 0.115926 * f);
            return d;
          })()),
            (i = (function () {
              var e,
                ...
                r,
                a,
                l = t.createBuffer(2, o, n);
              for (e = 0; e < l.numberOfChannels; e++)
                for (i = l.getChannelData(e), s = 0, r = 0; o > r; r++)
                  (a = 2 * Math.random() - 1),
                    (i[r] = (s + 0.02 * a) / 1.02),
                    (s = i[r]),
                    (i[r] *= 3.5);
            ...
            (s = (function () {
              var e,
                i,
                s,
                r = t.createBuffer(2, o, n);
              for (e = 0; e < r.numberOfChannels; e++)
                for (i = r.getChannelData(e), s = 0; o > s; s++)
                  i[s] = 2 * Math.random() - 1;
              return r;
            })());
        }),
    ...
    Module(function (t) {
      return (
        ...
        (t.NoiseSynth.defaults = {
          noise: { type: "white" },
          filter: { Q: 6, type: "highpass", rolloff: -24 },
      ...
      return (
        (t.PolySynth = function () {
          ...
          for (
            ...
            (s = new e.voice(arguments[2], arguments[3])),
              (this.voices[i] = s),
              s.connect(this.output);
          this._freeVoices = this.voices.slice(0);
        }),
        t.extend(t.PolySynth, t.Instrument),
        (t.PolySynth.defaults = { polyphony: 4, voice: t.MonoSynth }),
        (t.PolySynth.prototype.triggerAttack = function (t, e, i) {
          var s, n, o, r, a;
          for (Array.isArray(t) || (t = [t]), s = 0; s < t.length; s++)
            if (
              ((n = t[s]),
              (o = JSON.stringify(n)),
              this._activeVoices.hasOwnProperty(o))
            )
              this._activeVoices[o].triggerAttack(n, e, i);
            else if (this._freeVoices.length > 0)
              (r = this._freeVoices.shift()),
                r.triggerAttack(n, e, i),
                (this._activeVoices[o] = r);
            else if (this.stealVoices)
              for (a in this._activeVoices) {
        ...
        (t.PolySynth.prototype.triggerRelease = function (t, e) {
          var i, s, n;
          for (Array.isArray(t) || (t = [t]), i = 0; i < t.length; i++)
            (s = JSON.stringify(t[i])),
              (n = this._activeVoices[s]),
              n &&
                (n.triggerRelease(e),
                this._freeVoices.push(n),
                delete this._activeVoices[s],
                (n = null));
          return this;
        }),
        ...
        (t.PolySynth.prototype.releaseAll = function (t) {
          for (var e = 0; e < this.voices.length; e++)
            this.voices[e].triggerRelease(t);
          return this;
        }),
    ...
    Module(function (t) {
      return (
        ...
        (t.Player.prototype._start = function (e, i, s) {
          ...
          return (
            (i = this._loop
              ? this.defaultArg(i, this._loopStart)
              : this.defaultArg(i, 0)),
            (i = this.toSeconds(i)),
            (s = this.defaultArg(s, this._buffer.duration - i)),
            (e = this.toSeconds(e)),
            (s = this.toSeconds(s)),
            (this._source = this.context.createBufferSource()),
            ...
            this._loop
              ...
              : this._state.setStateAtTime(t.State.Stopped, e + s),
            (this._source.playbackRate.value = this._playbackRate),
            this._source.connect(this.output),
            this._loop ? this._source.start(e, i) : this._source.start(e, i, s),
            this
          );
        }),
    ...
    Module(function (t) {
      return (
        (t.Sampler = function (e, i) {
          (i = this.defaultArg(i, t.Sampler.defaults)),
            t.Instrument.call(this, i),
            (this.player = new t.Player(i.player)),
            (this.player.retrigger = !0),
            (this._buffers = {}),
            (this.envelope = new t.AmplitudeEnvelope(i.envelope)),
            (this.filterEnvelope = new t.FrequencyEnvelope(i.filterEnvelope)),
            (this._sample = i.sample),
            (this._pitch = i.pitch),
            (this.filter = new t.Filter(i.filter)),
            this._loadBuffers(e),
            (this.pitch = i.pitch),
        ...
        (t.Sampler.prototype._loadBuffers = function (e) {
          ...
          if (this.isString(e))
            ...
            for (i in e)
              (this._sample = i),
                (s = e[i]),
                (this._buffers[i] = new t.Buffer(s));
          }
        }),
        ...
        (t.Sampler.prototype.triggerAttack = function (t, e, i) {
          return (
            ...
            this.player.start(e),
            this.envelope.triggerAttack(e, i),
            this.filterEnvelope.triggerAttack(e),
            this
          );
        }),
        (t.Sampler.prototype.triggerRelease = function (t) {
          return (
            ...
            this.filterEnvelope.triggerRelease(t),
            this.envelope.triggerRelease(t),
            this.player.stop(this.toSeconds(this.envelope.release) + t),
            this
          );
        }),
        Object.defineProperty(t.Sampler.prototype, "sample", {
          ...
          set: function (t) {
            if (!this._buffers.hasOwnProperty(t))
              throw new Error("Sampler does not have a sample named " + t);
        ...
        Object.defineProperty(t.Sampler.prototype, "pitch", {
          ...
          set: function (t) {
            (this._pitch = t),
              (this.player.playbackRate = this.intervalToFrequencyRatio(t));
          },
        }),
        (t.Sampler.prototype.dispose = function () {
          ...
          for (var e in this._buffers)
            this._buffers[e].dispose(), (this._buffers[e] = null);
    ...
    Module(function (t) {
      return (
        (t.SimpleSynth = function (e) {
          (e = this.defaultArg(e, t.SimpleSynth.defaults)),
            t.Monophonic.call(this, e),
            (this.oscillator = new t.OmniOscillator(e.oscillator)),
            (this.frequency = this.oscillator.frequency),
            (this.detune = this.oscillator.detune),
        ...
        t.extend(t.SimpleSynth, t.Monophonic),
        (t.SimpleSynth.defaults = {
          oscillator: { type: "triangle" },
    ...
    Module(function (t) {
      return (
        (t.SimpleAM = function (e) {
          (e = this.defaultArg(e, t.SimpleAM.defaults)),
            t.Monophonic.call(this, e),
            (this.carrier = new t.SimpleSynth(e.carrier)),
            (this.modulator = new t.SimpleSynth(e.modulator)),
            (this.frequency = new t.Signal(440, t.Type.Frequency)),
            (this.harmonicity = new t.Multiply(e.harmonicity)),
            (this.harmonicity.units = t.Type.Positive),
            (this._modulationScale = new t.AudioToGain()),
        ...
        t.extend(t.SimpleAM, t.Monophonic),
        (t.SimpleAM.defaults = {
          harmonicity: 3,
          carrier: {
            volume: -10,
    ...
    Module(function (t) {
      return (
        (t.SimpleFM = function (e) {
          (e = this.defaultArg(e, t.SimpleFM.defaults)),
            t.Monophonic.call(this, e),
            (this.carrier = new t.SimpleSynth(e.carrier)),
            (this.carrier.volume.value = -10),
            (this.modulator = new t.SimpleSynth(e.modulator)),
        ...
        t.extend(t.SimpleFM, t.Monophonic),
        (t.SimpleFM.defaults = {
          harmonicity: 3,
          modulationIndex: 10,
          carrier: {
      ...
      return (
        ...
        (t.ExternalInput = function () {
          ...
          t.Source.call(this, e),
            ...
            (this._inputNum = e.inputNum),
            (this._gate = new t.Gain(0).connect(this.output));
        }),
        t.extend(t.ExternalInput, t.Source),
        (t.ExternalInput.defaults = { inputNum: 0 }),
        (t.ExternalInput.prototype._getUserMedia = function (e) {
          if (!t.ExternalInput.supported)
            throw new Error("browser does not support 'getUserMedia'");
          t.ExternalInput.sources[this._inputNum] &&
            (this._constraints = {
              audio: {
                optional: [
        ...
        (t.ExternalInput.prototype._onStream = function (t) {
          if (!this.isFunction(this.context.createMediaStreamSource))
            throw new Error(
              "browser does not support the 'MediaStreamSourceNode'"
            );
          this._stream ||
            ((this._stream = t),
        ...
        (t.ExternalInput.prototype.open = function (e) {
          return (
            (e = this.defaultArg(e, t.noOp)),
            t.ExternalInput.getSources(
              function () {
        ...
        (t.ExternalInput.prototype._start = function (t) {
          return (
            (t = this.toSeconds(t)), this._gate.gain.setValueAtTime(1, t), this
          );
        }),
        (t.ExternalInput.prototype._stop = function (t) {
          return (
            (t = this.toSeconds(t)), this._gate.gain.setValueAtTime(0, t), this
          );
        }),
        ...
        (t.ExternalInput.sources = []),
        (t.ExternalInput._canGetSources =
          !t.prototype.isUndef(window.MediaStreamTrack) &&
          t.prototype.isFunction(MediaStreamTrack.getSources)),
        Object.defineProperty(t.ExternalInput, "supported", {
          get: function () {
        ...
        (t.ExternalInput.getSources = function (e) {
          return (
            0 === t.ExternalInput.sources.length &&
            t.ExternalInput._canGetSources
              ? MediaStreamTrack.getSources(function (i) {
                  for (var s = 0; s < i.length; s++)
                    "audio" === i[s].kind &&
                      (t.ExternalInput.sources[s] = i[s]);
    ...
    Module(function (t) {
      return (
        (t.Microphone = function () {
          t.ExternalInput.call(this, 0);
        }),
        t.extend(t.Microphone, t.ExternalInput),
        Object.defineProperty(t.Microphone, "supported", {
          get: function () {
    ...
    Module(function (t) {
      return (
        (t.Clip = function (e, i) {
          ...
          (this.min = this.input = new t.Min(i)),
            this._readOnly("min"),
            (this.max = this.output = new t.Max(e)),
            this._readOnly("max"),
    ...
    Module(function (t) {
      (t.Route = function (i) {
        ...
        t.extend(t.Route, t.SignalBase),
        (t.Route.prototype.select = function (t, e) {
          return (
            (t = Math.floor(t)),
            this.gate.setValueAtTime(t, this.toSeconds(e)),
            this
        ...
        (t.Route.prototype.dispose = function () {
          this._writable("gate"), this.gate.dispose(), (this.gate = null);
          for (var e = 0; e < this.output.length; e++)
            this.output[e].dispose(), (this.output[e] = null);
          return t.prototype.dispose.call(this), this;
        });
      var e = function (e) {
        (this.selecter = new t.Equal(e)),
      ...
      return (
        (t.Switch = function (e) {
          (e = this.defaultArg(e, !1)),
            ...
            (this.gate = new t.Signal(0)),
            this._readOnly("gate"),
            (this._thresh = new t.GreaterThan(0.5)),
            this.input.connect(this.output),
            this.gate.chain(this._thresh, this.output.gain),
            e && this.open();
        }),
        t.extend(t.Switch, t.SignalBase),
        (t.Switch.prototype.open = function (t) {
