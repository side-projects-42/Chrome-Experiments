  ...
  return (function e(t, n, r) {
  ...
  })(
    {
      ...
      2: [
        ...
        { "./interval": 3, "./knowledge": 4, "./note": 5, daccord: 9 },
      ],
      3: [
        function (require, module, exports) {
          var knowledge = require("./knowledge");
        ...
        { "./knowledge": 4, "./vector": 8, "interval-coords": 13 },
      ],
      4: [
        function (require, module, exports) {
      ...
      5: [
        function (require, module, exports) {
          ...
          Note.prototype = {
            ...
            chroma: function () {
              var value =
                (vector.sum(vector.mul(this.coord, [12, 7])) - 3) % 12;
        ...
        function (require, module, exports) {
          ...
          module.exports = function (symbol) {
            ...
            for (var i = 0, len = symbol.length; i < len; i++) {
              ...
              if (parsing === "quality") {
                var sub3 =
                  i + 2 < len ? symbol.substr(i, 3).toLowerCase() : null;
                var sub2 =
                  i + 1 < len ? symbol.substr(i, 2).toLowerCase() : null;
      ...
      10: [
        ...
        { "accidental-value": 11, notecoord: 12 },
      ],
      11: [
        function (require, module, exports) {
      ...
      14: [
        ...
        { "accidental-value": 15, notecoord: 16 },
      ],
      15: [
        function (require, module, exports) {
