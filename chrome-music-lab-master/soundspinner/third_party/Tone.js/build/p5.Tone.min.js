!(function (root) {
  ...
  Main(function () {
    ...
    return (
      ...
      (s.prototype.sampleTime = 1 / s.context.sampleRate),
      ...
      s._initAudioContext(function (t) {
        (s.prototype.blockTime = 128 / t.sampleRate),
          (s.prototype.sampleTime = 1 / t.sampleRate),
          (n = t.createGain()),
          (n.gain.value = 0),
      ...
      return (
        ...
        (t.Envelope.prototype.triggerAttack = function (e, i) {
          var s,
            ...
            r,
            a,
            l = this.now() + this.blockTime;
          return (
            (e = this.toSeconds(e, l)),
            (s = this.toSeconds(this.attack)),
            (n = this.toSeconds(this.decay)),
            (i = this.defaultArg(i, 1)),
            (o = this.getValueAtTime(e)),
            o > 0 && ((r = 1 / s), (a = 1 - o), (s = a / r)),
            (s += e),
            this._attackCurve === t.Envelope.Type.Linear
        ...
        (t.Envelope.prototype.triggerRelease = function (e) {
          ...
          return (
            ...
            this.getValueAtTime(e) > 0 &&
              ((i = this.toSeconds(this.release)),
              this._releaseCurve === t.Envelope.Type.Linear
                ? this._sig.linearRampToValueBetween(0, e, e + i)
                : this._sig.exponentialRampToValueBetween(0, e, i + e)),
            this
          );
        }),
      ...
      return (
        ...
        Object.defineProperty(t.Clock.prototype, "lookAhead", {
          ...
          set: function (t) {
            "auto" === t
              ? (this._lookAhead = "auto")
              : (this._lookAhead = this.toSeconds(t));
          },
        }),
        ...
        Object.defineProperty(t.Chebyshev.prototype, "order", {
          ...
          set: function (t) {
            ...
            for (
              ...
              (n = (2 * s) / i - 1),
                0 === n ? (e[s] = 0) : (e[s] = this._getCoefficient(n, t, {}));
    ...
    Module(function (t) {
      ...
      return (
        ...
        Object.defineProperty(t.OmniOscillator.prototype, "width", {
          get: function () {
            return this._sourceType === e.Pulse
        ...
        Object.defineProperty(t.OmniOscillator.prototype, "modulationType", {
          get: function () {
            return this._sourceType === e.FM || this._sourceType === e.AM
      ...
      return (
        (t.AMSynth = function (e) {
          (e = this.defaultArg(e, t.AMSynth.defaults)),
            t.Monophonic.call(this, e),
            (this._carrier = new t.SimpleSynth()),
            (this._carrier.volume.value = -10),
            (this.oscillator = this._carrier.oscillator),
            (this.envelope = this._carrier.envelope.set(e.envelope)),
            (this._modulator = new t.SimpleSynth()),
      ...
      return (
        (t.FMSynth = function (e) {
          (e = this.defaultArg(e, t.FMSynth.defaults)),
            t.Monophonic.call(this, e),
            (this._carrier = new t.SimpleSynth(e.carrier)),
            (this._carrier.volume.value = -10),
            (this.oscillator = this._carrier.oscillator),
            (this.envelope = this._carrier.envelope.set(e.envelope)),
            (this._modulator = new t.SimpleSynth(e.modulator)),
            (this._modulator.volume.value = -10),
            (this.modulation = this._modulator.oscillator.set(e.modulation)),
            (this.modulationEnvelope = this._modulator.envelope.set(
              e.modulationEnvelope
        ...
        (t.MetalSynth = function (i) {
          ...
          for (
            i = this.defaultArg(i, t.MetalSynth.defaults),
              ...
              this._highpass = new t.Filter({ type: "highpass", Q: 0 }).connect(
                this._amplitue
              ),
            ...
            (n = new t.FMOscillator({
              type: "square",
              modulationType: "square",
              harmonicity: i.harmonicity,
              modulationIndex: i.modulationIndex,
            })),
              n.connect(this._highpass).start(0),
              (this._oscillators[s] = n),
              (o = new t.Multiply(e[s])),
              (this._freqMultipliers[s] = o),
    ...
    Module(function (t) {
      return (
        (t.PolySynth = function () {
          ...
          for (
            ...
            (s = new e.voice(arguments[2], arguments[3])),
              (this.voices[i] = s),
              s.connect(this.output),
              (this._triggers[i] = { release: -1, note: null, voice: s });
        ...
        (t.PolySynth.prototype.triggerAttack = function (t, e, i) {
          var s, n, o, r, a;
          for (
            Array.isArray(t) || (t = [t]), e = this.toSeconds(e), s = 0;
            s < t.length;
            s++
          ) {
            for (
              n = t[s], o = this._triggers[0], r = 0, a = 1;
              a < this._triggers.length;
              a++
            )
              this._triggers[a].release < o.release &&
                ((o = this._triggers[a]), (r = a));
            (o.release = 1 / 0),
              (o.note = JSON.stringify(n)),
              o.voice.triggerAttack(n, e, i);
          }
          return this;
        }),
        ...
        (t.PolySynth.prototype.triggerRelease = function (t, e) {
          ...
          for (
            ...
            for (
              s = JSON.stringify(t[i]), n = 0;
              n < this._triggers.length;
              n++
            )
              (o = this._triggers[n]),
                o.note === s &&
        ...
        (t.PolySynth.prototype.dispose = function () {
          ...
          return (this.voices = null), (this._triggers = null), this;
        }),
        t.PolySynth
      );
    }),
    ...
    Module(function (t) {
      return (
        ...
        (t.ExternalInput.prototype._getUserMedia = function (e, i) {
          t.ExternalInput.supported ||
        ...
        (t.ExternalInput.prototype.open = function (e, i) {
          return (
            (e = this.defaultArg(e, t.noOp)),
            (i = this.defaultArg(i, t.noOp)),
            t.ExternalInput.getSources(
              function () {
                this._getUserMedia(e, i);
              }.bind(this)
            ),
            this
          );
    ...
    Module(function (t) {
      return (
        (t.MultiPlayer = function (e) {
          t.call(this, 0, 1),
            (this._buffers = {}),
            (this._sourceOutput = new t.Gain()),
            this._sourceOutput.connect(this.output),
            this.isObject(e) && this.addBuffer(e),
            (this.output.channelCount = 2),
            (this.output.channelCountMode = "explicit");
        }),
        t.extend(t.MultiPlayer),
        (t.MultiPlayer.prototype.start = function (t, e, i) {
          var s, n, o, r, a;
          return (
            (i = this.defaultArg(i, {
              playbackRate: 1,
            ...
            this._buffers.hasOwnProperty(t) &&
              ((s = this._buffers[t]),
              (n = this.context.createBufferSource()),
              (n.buffer = s.get()),
              (o = this.context.createGain()),
              n.connect(o),
              o.connect(this._sourceOutput),
              (n.playbackRate.value = i.playbackRate),
              (e = this.toSeconds(e)),
              n.start(e, i.offset),
              0 !== i.attack
                ? (o.gain.setValueAtTime(0, e),
                  o.gain.linearRampToValueAtTime(
                    i.gain,
                    e + this.toSeconds(i.attack)
                  ))
                : o.gain.setValueAtTime(i.gain, e),
              this.isUndef(i.duration) ||
                ((r = this.toSeconds(i.duration, s.duration)),
                (a = this.toSeconds(i.release)),
                o.gain.setValueAtTime(i.gain, e + r),
                o.gain.linearRampToValueAtTime(0, e + r + a),
                n.stop(e + r + a))),
            this
          );
        }),
        (t.MultiPlayer.prototype.stopAll = function (e, i) {
          return (
            (e = this.toSeconds(e)),
            (i = this.defaultArg(i, 0.01)),
            (i = this.toSeconds(i)),
            this._sourceOutput.gain.setValueAtTime(1, e),
            this._sourceOutput.gain.linearRampToValueAtTime(0, e + i),
            (this._sourceOutput = new t.Gain().connect(this.output)),
            this
          );
        }),
        (t.MultiPlayer.prototype.addBuffer = function (e, i, s) {
          function n() {
            r--, 0 === r && this.isFunction(i) && i();
          }
          var o,
            r = 0;
          if (this.isObject(e)) for (o in e) r++, this.addBuffer(o, e[o], n);
          else
            i instanceof t.Buffer
              ? (this._buffers[e] = i)
              : (this._buffers[e] = new t.Buffer(i, s));
          return this;
        }),
    ...
    "function" == typeof define && define.amd
      ...
      ? (module.exports = Tone)
      : (root.Tone = Tone),
    (Tone.registeredPreload = function (t) {
      return function () {
        t();
      };
    }),
    (Tone.Buffer.load = function (t, e) {
      var i = Tone.registeredPreload(),
        s = new XMLHttpRequest();
      return (
        s.open("GET", t, !0),
        (s.responseType = "arraybuffer"),
        (s.onload = function () {
          Tone.context.decodeAudioData(s.response, function (s) {
            if (!s) throw new Error("could not decode audio data:" + t);
            e(s), i();
          });
        }),
        s.send(),
