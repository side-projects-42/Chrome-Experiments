...
module.exports = function (maxRecordTime, container) {
  ...
  (_self.init = function () {
    ...
    (_self.attachControls = function () {
      ...
      _self.waveDisplay = $("<div>")
        .prop("id", "WaveDisplay")
        .appendTo(container);
      _self.recordButton = $("<div>")
        .prop("id", "RecordButton")
        .appendTo(_self.waveDisplay);
    ...
    (_self.mouseDown = function (e) {
      ...
      _self.pRad = MathUtils.getAngle(_self.getViewCenter(), [
        e.pageX,
        e.pageY,
      ]);
    ...
    (_self._updateSmoothRotation = function (newVal) {
      var alpha = 0.1;
      _self.smoothedRotation =
        newVal * alpha + _self.smoothedRotation * (1 - alpha);
    ...
    (_self.rotationDragUpdate = function () {
      ...
      var rotMax = 0.5;
      if (
        _self.mousePos[0] == _self.pLoc[0] &&
        _self.mousePos[1] == _self.pLoc[1]
      ) {
