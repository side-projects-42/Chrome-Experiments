...
define(["mic/Overlay", "Tone/source/Microphone"], function (Overlay, Mic) {
  var Microphone = function (container, micButton) {
    ...
    if (!Mic.supported) {
      ...
      this._micButton.addEventListener(
        "click",
        this._startRecording.bind(this)
      );
    }
  };
  ...
  Microphone.prototype._doneRecording = function () {
    ...
    this.onbuffer(
      this._overlay.buffer,
      this._overlay.duration,
      this._overlay.onset
    );
  };
