    ...
    if (files) {
      ...
      if (file.type === "audio/midi" || file.type === "audio/mid") {
        ...
        reader.onload = function (e) {
          ...
          const maxNotes = Math.max.apply(
            Math,
            midi.tracks.map(function (t) {
          ...
          document.querySelectorAll("#Previous, #Next").forEach(function (n) {
            n.classList.add("Hidden");
          });
          document.getElementById("Midi").querySelector(".Text").innerHTML =
            file.name || "untitled.mid";
