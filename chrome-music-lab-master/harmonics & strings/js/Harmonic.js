...
var Harmonic = function (indPm, controllerPm) {
  ...
  this.strokeMin = 2.5 * 2;
  this.strokeMax = 3.8 * 2;
...
Harmonic.prototype.upd = function () {
  ...
  for (var j = 0; j <= 1; j++) {
    ...
    for (var i = 0; i < this.periods * 2; i += 2) {
      ...
      C1 = {
        x: xCenter + flipSign * amplitudeCurr,
        y: this.yp + i * interval + (this.periodLength / 2) * curviness,
      };
      C2 = {
        x: xCenter + flipSign * amplitudeCurr,
        y: this.yp + (i + 1) * interval - (this.periodLength / 2) * curviness,
      };
      ...
      C2 = {
        x: xCenter - flipSign * amplitudeCurr,
        y: this.yp + (i + 2) * interval - (this.periodLength / 2) * curviness,
      };
