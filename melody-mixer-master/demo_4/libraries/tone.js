(function (root, factory) {
  ...
  Main(function () {
    ...
    Tone.defaultArg = function (given, fallback) {
      if (Tone.isObject(given) && Tone.isObject(fallback)) {
        ...
        for (var givenProp in given) {
          ret[givenProp] = Tone.defaultArg(
            fallback[givenProp],
            given[givenProp]
          );
        }
        for (var fallbackProp in fallback) {
          ret[fallbackProp] = Tone.defaultArg(
            given[fallbackProp],
    ...
    Tone.isNote = function (arg) {
      return (
        Tone.isString(arg) && /^([a-g]{1}(?:b|#|x|bb)?)(-?[0-9]+)/i.test(arg)
      );
    };
    /**
     *  An empty function.
  ...
  Module(function (Tone) {
    ...
    Tone.SignalBase.prototype.connect = function (
      ...
      Tone.AudioNode.prototype.connect.call(
        this,
        node,
        outputNumber,
        inputNumber
  ...
  Module(function (Tone) {
    ...
    Tone.Frequency.prototype.frequencyToMidi = function (frequency) {
      return (
        69 +
        Math.round((12 * Math.log(frequency / Tone.Frequency.A4)) / Math.LN2)
      );
    };
  ...
  Module(function (Tone) {
    ...
    Tone.CrossFade = function (initialFade) {
      ...
      this.fade = new Tone.Signal(
        Tone.defaultArg(initialFade, 0.5),
  ...
  Module(function (Tone) {
    ...
    Tone.FeedbackCombFilter = function () {
      ...
      this._delay =
        this.input =
        this.output =
          new Tone.Delay(options.delayTime);
      /**
  ...
  Module(function (Tone) {
    ...
    function _wrapScheduleMethods(method) {
      return function (value, time) {
        ...
        var ticksUntilTime = this._getTickUntilEvent(
          previousEvent,
    ...
    Tone.TickSignal.prototype.setValueAtTime = _wrapScheduleMethods(
      Tone.TimelineSignal.prototype.setValueAtTime
    );
    Tone.TickSignal.prototype.linearRampToValueAtTime = _wrapScheduleMethods(
      Tone.TimelineSignal.prototype.linearRampToValueAtTime
    );
    /**
     *  Start exponentially approaching the target value at the given time with
     *  a rate having the given time constant.
    ...
    Tone.TickSignal.prototype.setTargetAtTime = function (
      ...
      for (var i = 0; i <= segments; i++) {
        ...
        var rampVal = this._exponentialApproach(
          prevEvent.time,
          prevEvent.value,
          value,
          constant,
    ...
    Tone.TickSignal.prototype.exponentialRampToValueAtTime = function (
      ...
      for (var i = 0; i <= segments; i++) {
        ...
        var rampVal = this._exponentialInterpolate(
          prevEvent.time,
          prevEvent.value,
          time,
          value,
  ...
  Module(function (Tone) {
    ...
    Tone.Clock = function () {
       ...
       *  @signal
       */
      this.frequency = new Tone.TickSignal(
        options.frequency,
        Tone.Type.Frequency
      );
  ...
  Module(function (Tone) {
    ...
    Object.defineProperty(Tone.Transport.prototype, "progress", {
      get: function () {
        if (this.loop) {
          return (
            (this.ticks - this._loopStart) / (this._loopEnd - this._loopStart)
          );
        } else {
          return 0;
        }
  ...
  Module(function (Tone) {
    ...
    Tone.Source.prototype.start = function (time, offset, duration) {
      ...
      if (
        !this.retrigger &&
        this._state.getValueAtTime(time) === Tone.State.Started
      ) {
        this.stop(time);
      }
      this._state.setStateAtTime(Tone.State.Started, time);
    ...
    Tone.Source.prototype.sync = function () {
      ...
      this._syncedStop = function (time) {
        if (
          this._state.getValueAtTime(Tone.Transport.seconds) ===
          Tone.State.Started
        ) {
          this._stop(time);
        }
  ...
  Module(function (Tone) {
     ...
     *  @readOnly
     */
    Tone.Panner.hasStereoPanner =
      Tone.context && Tone.isFunction(Tone.context.createStereoPanner);
    /**
     *  Clean up.
  ...
  Module(function (Tone) {
    ...
    Tone.Solo.prototype._isSoloed = function () {
      if (Tone.isArray(this.context._currentSolo)) {
        return (
          this.context._currentSolo.length !== 0 &&
          this.context._currentSolo.indexOf(this) !== -1
        );
      } else {
        return false;
      }
    ...
    Tone.Solo.prototype._noSolos = function () {
      return (
        !Tone.isArray(this.context._currentSolo) ||
        this.context._currentSolo.length === 0
      );
    };
    /**
  ...
  Module(function (Tone) {
    ...
    Tone.Buffer.prototype.slice = function (start, end) {
      ...
      var startSamples = Math.floor(
        this.context.sampleRate * this.toSeconds(start)
      );
      var endSamples = Math.floor(
        this.context.sampleRate * this.toSeconds(end)
      );
      var replacement = [];
    ...
    Tone.Buffer.load = function (url, onload, onerror) {
      ...
      function onProgress() {
        ...
        Tone.Buffer.emit(
          "progress",
          totalProgress / Tone.Buffer._downloadQueue.length
        );
      }
  ...
  Module(function (Tone) {
    ...
    Tone.FeedbackEffect = function () {
       ...
       *  @private
       */
      this._feedbackGain = new Tone.Gain(
        options.feedback,
        Tone.Type.NormalRange
      );
      /**
  ...
  Module(function (Tone) {
      ...
      this._state.forEachFrom(
        ...
        function (event) {
          ...
          if (event.state === Tone.State.Started) {
            ...
            var startTick =
              event.time + Math.round(this.startOffset / this._playbackRate);
            if (this._loop) {
              duration = Infinity;
    ...
    Tone.Event.prototype._tick = function (time) {
      if (
        !this.mute &&
        this._state.getValueAtTime(Tone.Transport.ticks) === Tone.State.Started
      ) {
      ...
      for (var i = this._events.length - 1; i >= 0; i--) {
        ...
        if (event instanceof Tone.Part) {
          ...
          if (event.startOffset === time) {
            if (
              Tone.isUndef(value) ||
              (!Tone.isUndef(value) && event.value === value)
            ) {
  ...
  Module(function (Tone) {
    ...
    Tone.DuoSynth = function (options) {
       ...
       *  @private
       */
      this._vibratoGain = new Tone.Gain(
        options.vibratoAmount,
        Tone.Type.Positive
      );
      /**
  ...
  Module(function (Tone) {
    ...
    Tone.BufferSource.prototype.start = function (
      ...
      if (this.buffer.loaded) {
        ...
        var computedDur = Tone.defaultArg(
          duration,
    ...
    Tone.BufferSource.prototype.stop = function (time, fadeOutTime) {
      if (this.buffer.loaded) {
        ...
        if (this._stopTime === -1 || this._stopTime > time) {
          ...
          this._onendedTimeout = Tone.context.setTimeout(
  ...
  Module(function (Tone) {
    ...
    Tone.Sampler.prototype.add = function (note, url, callback) {
      if (Tone.isNote(note)) {
        ...
        throw new Error(
          "Tone.Sampler: note must be the note's pitch. Instead got " + note
        );
      }
    };
    /**
  ...
  Module(function (Tone) {
    ...
    Tone.TransportTimelineSignal = function () {
       ...
       * @type {Number}
       */
      this._synced = Tone.Transport.scheduleRepeat(
    ...
    Tone.TransportTimelineSignal.prototype.linearRampToValueAtTime = function (
      ...
      time = this.toTicks(time);
      Tone.TimelineSignal.prototype.linearRampToValueAtTime.call(
        this,
        value,
        time
      );
     ...
     * @return {Tone.TransportTimelineSignal}       this
     */
    Tone.TransportTimelineSignal.prototype.exponentialRampToValueAtTime =
      function (value, time) {
        time = this.toTicks(time);
        Tone.TimelineSignal.prototype.exponentialRampToValueAtTime.call(
          this,
          value,
          time
        );
    ...
    Tone.TransportTimelineSignal.prototype.setTargetAtTime = function (
      ...
      Tone.TimelineSignal.prototype.setTargetAtTime.call(
        this,
        value,
        startTime,
        timeConstant
    ...
    Tone.TransportTimelineSignal.prototype.setValueCurveAtTime = function (
      ...
      Tone.TimelineSignal.prototype.setValueCurveAtTime.call(
        this,
        values,
        startTime,
        duration,
  ...
  Module(function (Tone) {
    ...
    Tone.MultiPlayer = function (urls) {
      ...
      if (
        arguments.length === 1 &&
        !Tone.isUndef(arguments[0]) &&
        !arguments[0].hasOwnProperty("urls")
      ) {
        urls = { urls: urls };
      }
      var options = Tone.defaults(
    ...
    Tone.MultiPlayer.prototype.stop = function (bufferName, time) {
      if (
        this._activeSources[bufferName] &&
        this._activeSources[bufferName].length
      ) {
        time = this.toSeconds(time);
  ...
  Module(function (Tone) {
    ...
    Tone.Player.prototype._start = function (startTime, offset, duration) {
      ...
      offset = this.toSeconds(offset);
      duration = Tone.defaultArg(
        duration,
        Math.max(this._buffer.duration - offset, 0)
      );
      duration = this.toSeconds(duration);
      startTime = this.toSeconds(startTime);
      // //make the source
  ...
  Module(function (Tone) {
      ...
      return Tone.UserMedia.enumerateDevices().then(
        function (devices) {
          ...
          if (Tone.isNumber(labelOrId)) {
            ...
            if (!device) {
              throw new Error(
                "Tone.UserMedia: no matching device: " + labelOrId
              );
            }
          }
          this._device = device;
    ...
    Object.defineProperty(Tone.UserMedia, "supported", {
      get: function () {
        return (
          !Tone.isUndef(navigator.mediaDevices) &&
          Tone.isFunction(navigator.mediaDevices.getUserMedia)
        );
      },
    });
