...
var Nav = (module.exports = function () {
  ...
  this.init = function () {
    ...
    this.sequencer =
      this.sequencerWrapper.getElementsByClassName("container")[0];
    ...
    this.previewIcon.addEventListener(
      "click",
      function () {
    ...
    this.shuffleIcon.addEventListener(
      "click",
      function () {
    ...
    var setTempoSlider = function (value) {
      ...
      var normal =
        value /
        (sliderData.max - sliderData.min); /* the percentage slider value */
