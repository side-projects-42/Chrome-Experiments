...
var Dragger = (module.exports = function (obj) {
  ...
  this.updateOutlineNoise = function (percentage, stateValue, colorData) {
    ...
    var randY;
    var randResolution =
      Data.draggerNoiseResolution * colorData.r * (1 - stateValue); //0
    var randMultiplier =
      Data.draggerNoiseMultiplier * colorData.g * (1 - stateValue) * 1.0 + 0.25; //0
    var randSpeed =
      Data.draggerNoiseMultiplier * colorData.b * (1 - stateValue); //0
  ...
  this.animatePosition = function (soundIndex, panner, zoomer) {
    ...
    this.tween = new TWEEN.Tween(state)
      ...
      .onComplete(
        function () {
          this.dispatchEvent(
            new CustomEvent("ON_DRAGGER_ANIMATION_COMPLETE", {
              detail: { draggerIndex: this.draggerIndex },
            })
          );
        }.bind(scope)
      )
  ...
  this.onMouseDown = function (event) {
    ...
    var onMove = function (event) {
      ...
      this.dispatchEvent(
        new CustomEvent("ON_MOUSE_DRAGGING", { detail: this.position })
      );
    ...
    var anchorOffset = new THREE.Vector2(
