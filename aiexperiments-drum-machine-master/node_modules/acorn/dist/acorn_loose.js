(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? factory(exports, require("./acorn.js"))
    : typeof define === "function" && define.amd
    ? define(["exports", "./acorn.js"], factory)
    : factory(
  ...
  LooseParser.prototype.canInsertSemicolon = function canInsertSemicolon() {
    return (
      this.tok.type === acorn.tokTypes.eof ||
      this.tok.type === acorn.tokTypes.braceR ||
  ...
  LooseParser.prototype.lineEnd = function lineEnd(pos) {
    while (
      ...
      !acorn.isNewLine(this.input.charCodeAt(pos))
    )
      ++pos;
    return pos;
  };
  ...
  function isSpace(ch) {
    return (
      (ch < 14 && ch > 8) || ch === 32 || ch === 160 || acorn.isNewLine(ch)
    );
  }
  ...
  lp.readToken = function () {
    ...
    for (;;) {
      try {
        this$1.toks.next();
        if (
          this$1.toks.type === acorn.tokTypes.dot &&
  ...
  lp$1.parseTopLevel = function () {
    ...
    var node = this.startNodeAt(
      this.options.locations ? [0, acorn.getLineInfo(this.input, 0)] : 0
    );
    node.body = [];
    ...
    switch (starttype) {
      ...
      case acorn.tokTypes._continue:
        ...
        if (this.semicolon() || this.canInsertSemicolon()) {
          ...
          node.label =
            this.tok.type === acorn.tokTypes.name ? this.parseIdent() : null;
          this.semicolon();
        }
      ...
      case acorn.tokTypes._do:
        ...
        node.test = this.eat(acorn.tokTypes._while)
      ...
      case acorn.tokTypes._for:
        ...
        if (
          isLet ||
          this.tok.type === acorn.tokTypes._var ||
          this.tok.type === acorn.tokTypes._const
        ) {
          var init$1 = this.parseVar(true, isLet ? "let" : this.tok.value);
          if (
            init$1.declarations.length === 1 &&
            (this.tok.type === acorn.tokTypes._in || this.isContextual("of"))
          ) {
      ...
      case acorn.tokTypes._if:
        ...
        node.alternate = this.eat(acorn.tokTypes._else)
          ? this.parseStatement()
          : null;
      ...
      case acorn.tokTypes._switch:
        ...
        while (!this.closes(acorn.tokTypes.braceR, blockIndent, line, true)) {
          if (
            this$1.tok.type === acorn.tokTypes._case ||
            this$1.tok.type === acorn.tokTypes._default
          ) {
      ...
      case acorn.tokTypes._try:
        ...
        node.finalizer = this.eat(acorn.tokTypes._finally)
          ? this.parseBlock()
          : null;
  ...
  lp$1.parseFor = function (node, init) {
    ...
    if (
      this.eat(acorn.tokTypes.semi) &&
      this.tok.type !== acorn.tokTypes.parenR
    )
  ...
  lp$1.parseForIn = function (node, init) {
    var type =
      this.tok.type === acorn.tokTypes._in
        ? "ForInStatement"
        : "ForOfStatement";
    this.next();
    node.left = init;
    ...
    do {
      ...
      decl.id =
        this$1.options.ecmaVersion >= 6
          ...
          : this$1.parseIdent();
      decl.init = this$1.eat(acorn.tokTypes.eq)
  ...
  lp$1.parseClass = function (isStatement) {
    ...
    node.superClass = this.eat(acorn.tokTypes._extends)
    ...
    while (!this.closes(acorn.tokTypes.braceR, indent, line)) {
      ...
      if (
        ...
        this$1.tok.type != acorn.tokTypes.parenL &&
        this$1.tok.type != acorn.tokTypes.braceL
      ) {
        method.static = true;
        isGenerator = this$1.eat(acorn.tokTypes.star);
        this$1.parsePropertyName(method);
  ...
  lp$1.parseImport = function () {
    ...
    if (this.tok.type === acorn.tokTypes.string) {
      ...
      node.source =
        this.eatContextual("from") && this.tok.type == acorn.tokTypes.string
          ? this.parseExprAtom()
          : this.dummyString();
  ...
  lp$2.parseMaybeAssign = function (noIn) {
    if (this.toks.isContextual("yield")) {
      ...
      if (
        ...
        (this.tok.type != acorn.tokTypes.star && !this.tok.type.startsExpr)
      ) {
        node.delegate = false;
        node.argument = null;
      } else {
    ...
    if (this.tok.type.isAssign) {
      ...
      node$1.left =
        this.tok.type === acorn.tokTypes.eq
  ...
  lp$2.parseMaybeConditional = function (noIn) {
    ...
    if (this.eat(acorn.tokTypes.question)) {
      ...
      node.alternate = this.expect(acorn.tokTypes.colon)
  ...
  lp$2.parseSubscripts = function (base, start, noCalls, startIndent, line) {
    ...
    for (;;) {
      if (
        ...
        if (
          this$1.tok.type == acorn.tokTypes.dot &&
          this$1.curIndent == startIndent
        )
          --startIndent;
        else return base;
  ...
  lp$2.parseExprAtom = function () {
    ...
    switch (this.tok.type) {
      ...
      case acorn.tokTypes._super:
        var type =
          this.tok.type === acorn.tokTypes._this ? "ThisExpression" : "Super";
        node = this.startNode();
        this.next();
        return this.finishNode(node, type);
      ...
      case acorn.tokTypes.name:
        ...
        return this.eat(acorn.tokTypes.arrow)
      ...
      case acorn.tokTypes._false:
        node = this.startNode();
        node.value =
          this.tok.type === acorn.tokTypes._null
            ? null
            : this.tok.type === acorn.tokTypes._true;
  ...
  lp$2.parseObj = function () {
    ...
    while (!this.closes(acorn.tokTypes.braceR, indent, line)) {
      ...
      if (this$1.eat(acorn.tokTypes.colon)) {
        ...
        this$1.tok.type != acorn.tokTypes.comma &&
        this$1.tok.type != acorn.tokTypes.braceR
      ) {
  ...
  lp$2.parsePropertyName = function (prop) {
    ...
    var key =
      this.tok.type === acorn.tokTypes.num ||
      this.tok.type === acorn.tokTypes.string
        ? this.parseExprAtom()
        : this.parseIdent();
  ...
  lp$2.parseIdent = function () {
    var name =
      this.tok.type === acorn.tokTypes.name
        ? this.tok.value
  ...
  lp$2.parseMethod = function (isGenerator) {
    ...
    node.expression =
      this.options.ecmaVersion >= 6 && this.tok.type !== acorn.tokTypes.braceL;
