...
assert.equal(
  new Buffer("KioqKioqKioqKio=", "base64").toString(),
  "***********"
);
assert.equal(
  new Buffer("KioqKioqKioqKioq", "base64").toString(),
  "************"
);
assert.equal(
  new Buffer("KioqKioqKioqKioqKg==", "base64").toString(),
  "*************"
);
assert.equal(
  new Buffer("KioqKioqKioqKioqKio=", "base64").toString(),
  "**************"
);
assert.equal(
  new Buffer("KioqKioqKioqKioqKioq", "base64").toString(),
  "***************"
);
assert.equal(
  new Buffer("KioqKioqKioqKioqKioqKg==", "base64").toString(),
  "****************"
);
assert.equal(
  new Buffer("KioqKioqKioqKioqKioqKio=", "base64").toString(),
  "*****************"
);
assert.equal(
  new Buffer("KioqKioqKioqKioqKioqKioq", "base64").toString(),
  "******************"
);
assert.equal(
  new Buffer("KioqKioqKioqKioqKioqKioqKg==", "base64").toString(),
  "*******************"
);
assert.equal(
  new Buffer("KioqKioqKioqKioqKioqKioqKio=", "base64").toString(),
  "********************"
);
