...
assert.strictEqual(
  Buffer.from("\u00e8", "latin1").indexOf("\u00e8", "latin1"),
  0
);
assert.strictEqual(
...
assert.strictEqual(
  Buffer.from("\u00e8", "binary").indexOf("\u00e8", "binary"),
  0
);
assert.strictEqual(
...

{
  ...
  assert.equal(
    4,
    twoByteString.indexOf(Buffer.from("\u03a3", "ucs2"), -6, "ucs2")
  );
  assert.equal(-1, twoByteString.indexOf("\u03a3", -2, "ucs2"));
}

var mixedByteStringUcs2 = Buffer.from(
  "\u039a\u0391abc\u03a3\u03a3\u0395",
  "ucs2"
);
...

{
  ...
  assert.equal(
    0,
    twoByteString.indexOf("\u039a\u0391", 0, "ucs2"),
    "Lambda Alpha"
  );
  assert.equal(
    2,
    twoByteString.indexOf("\u0391\u03a3", 0, "ucs2"),
    "Alpha Sigma"
  );
  assert.equal(
    4,
    twoByteString.indexOf("\u03a3\u03a3", 0, "ucs2"),
    "Sigma Sigma"
  );
  assert.equal(
    6,
    twoByteString.indexOf("\u03a3\u0395", 0, "ucs2"),
    "Sigma Epsilon"
  );
}
...
assert.equal(
  1534,
  longBufferString.indexOf("AJABACA", 511),
...
assert.equal(
  511,
  longBufferString.indexOf(pattern),
  "Long JABACABA..., First J"
);
assert.equal(
  1535,
  longBufferString.indexOf(pattern, 512),
