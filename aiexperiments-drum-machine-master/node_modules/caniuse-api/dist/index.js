...
exports.getBrowserScope =
  exports.setBrowserScope =
  exports.getLatestStableBrowsers =
  exports.find =
  exports.isSupported =
  exports.getSupport =
  exports.features =
...
var parse = (0, _lodash2.default)(
  _utils.parseCaniuseData,
  function (feature, browsers) {
...
function getSupport(query) {
  ...
  try {
    ...
    throw new ReferenceError(
      "Please provide a proper feature name. Cannot find " + query
    );
  }
...
function isSupported(feature, browsers) {
  ...
  return (0, _browserslist2.default)(browsers)
