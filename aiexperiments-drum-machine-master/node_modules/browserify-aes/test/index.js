  ...
  types.forEach(function (cipher) {
    ...
    types.forEach(function (cipher) {
      ...
      test("fixture " + i + " " + cipher + "-iv", function (t) {
        t.plan(1);
        var suite = crypto.createCipheriv(
          cipher,
          ebtk(_crypto, fixture.password, modes[cipher].key).key,
          new Buffer(fixture.iv, "hex")
        );
        var buf = new Buffer("");
        suite.on("data", function (d) {
          buf = Buffer.concat([buf, d]);
      ...
      test("fixture " + i + " " + cipher + "-legacy-iv", function (t) {
        ...
        var buf = new Buffer("");
        var suite2 = _crypto.createCipheriv(
          cipher,
          ebtk(_crypto, fixture.password, modes[cipher].key).key,
          new Buffer(fixture.iv, "hex")
        );
      ...
      test("fixture " + i + " " + cipher + "-iv-decrypt", function (t) {
        t.plan(1);
        var suite = crypto.createDecipheriv(
          cipher,
          ebtk(_crypto, fixture.password, modes[cipher].key).key,
          new Buffer(fixture.iv, "hex")
        );
      ...
      test("fixture " + i + " " + cipher + "-decrypt-legacy", function (t) {
        ...
        var buf = new Buffer("");
        var suite2 = _crypto.createDecipheriv(
          cipher,
          ebtk(_crypto, fixture.password, modes[cipher].key).key,
          new Buffer(fixture.iv, "hex")
        );
