(function () {
  ...
  Gradient = (function (superClass) {
    ...
    Gradient.prototype.replaceFirst = function () {
      ...
      (params = arguments[0]),
        (words = 2 <= arguments.length ? slice.call(arguments, 1) : []);
    ...
    Gradient.prototype.fixRadial = function (params) {
      ...
      return params.splice.apply(
        params,
        [0, i].concat(slice.call(second), [params[i + 2]], [first])
      );
    };
