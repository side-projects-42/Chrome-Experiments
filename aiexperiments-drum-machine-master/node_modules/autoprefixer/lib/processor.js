        ...
        (function (_this) {
          return function (decl) {
            ...
            if (
              ...
              if (
                display !== "grid" &&
                _this.prefixes.options.flexbox !== false
              ) {
      ...
      return css.walkDecls(
        (function (_this) {
          return function (decl, i) {
            ...
            if (
              (ref1 = _this.prefixes.remove[decl.prop]) != null
                ? ref1.remove
                : void 0
            ) {
