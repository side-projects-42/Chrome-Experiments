(function () {
  ...
  prefix = function () {
    ...
    (names =
      2 <= arguments.length
        ? slice.call(arguments, 0, (j = arguments.length - 1))
        : ((j = 0), [])),
      (data = arguments[j++]);
    results = [];
  ...
  add = function () {
    ...
    for (k = 0, len = names.length; k < len; k++) {
      name = names[k];
      results.push(
        (result[name].browsers = sort(
          result[name].browsers.concat(data.browsers)
        ))
      );
    }
    return results;
  ...
  feature(
    require("caniuse-db/features-json/border-radius.json"),
    function (browsers) {
      return prefix(
        "border-radius",
  ...
  feature(
    require("caniuse-db/features-json/css-boxshadow.json"),
    function (browsers) {
  ...
  feature(
    require("caniuse-db/features-json/css-animation.json"),
    function (browsers) {
      return prefix(
        "animation",
        "animation-name",
  ...
  feature(
    require("caniuse-db/features-json/css-transitions.json"),
    function (browsers) {
      return prefix(
        "transition",
        "transition-property",
  ...
  feature(
    require("caniuse-db/features-json/transforms2d.json"),
    function (browsers) {
  ...
  feature(
    require("caniuse-db/features-json/css3-boxsizing.json"),
    function (browsers) {
  ...
  feature(
    require("caniuse-db/features-json/css-filters.json"),
    function (browsers) {
  ...
  feature(
    require("caniuse-db/features-json/multicolumn.json"),
    function (browsers) {
      prefix(
        "columns",
        "column-width",
  ...
  feature(
    require("caniuse-db/features-json/font-feature.json"),
    function (browsers) {
      return prefix(
  ...
  feature(
    require("caniuse-db/features-json/font-kerning.json"),
    function (browsers) {
  ...
  feature(
    require("caniuse-db/features-json/border-image.json"),
    function (browsers) {
  ...
  feature(
    require("caniuse-db/features-json/css-selection.json"),
    function (browsers) {
  ...
  feature(
    require("caniuse-db/features-json/css-placeholder.json"),
    function (browsers) {
      browsers = browsers.map(function (i) {
  ...
  feature(
    require("caniuse-db/features-json/css-hyphens.json"),
    function (browsers) {
  ...
  feature(
    require("caniuse-db/features-json/css3-tabsize.json"),
    function (browsers) {
  ...
  feature(
    require("caniuse-db/features-json/intrinsic-width.json"),
    function (browsers) {
      return prefix(
        "max-content",
        "min-content",
  ...
  feature(
    require("caniuse-db/features-json/css-sticky.json"),
    function (browsers) {
  ...
  feature(
    require("caniuse-db/features-json/pointer.json"),
    function (browsers) {
  ...
  feature(
    require("caniuse-db/features-json/css-masks.json"),
    function (browsers) {
      prefix(
        "mask-clip",
        "mask-composite",
  ...
  feature(
    require("caniuse-db/features-json/css-clip-path.json"),
    function (browsers) {
  ...
  feature(
    require("caniuse-db/features-json/object-fit.json"),
    function (browsers) {
  ...
  feature(
    require("caniuse-db/features-json/css-shapes.json"),
    function (browsers) {
  ...
  feature(
    require("caniuse-db/features-json/text-overflow.json"),
    function (browsers) {
  ...
  feature(
    require("caniuse-db/features-json/css-appearance.json"),
    function (browsers) {
  ...
  feature(
    require("caniuse-db/features-json/css-snappoints.json"),
    function (browsers) {
      return prefix(
        "scroll-snap-type",
  ...
  feature(
    require("caniuse-db/features-json/css-regions.json"),
    function (browsers) {
  ...
  feature(
    require("caniuse-db/features-json/css-image-set.json"),
    function (browsers) {
  ...
  feature(
    require("caniuse-db/features-json/css-cross-fade.json"),
    function (browsers) {
  ...
  feature(
    require("caniuse-db/features-json/text-emphasis.json"),
    function (browsers) {
      return prefix(
        "text-emphasis",
  ...
  feature(
    require("caniuse-db/features-json/css-any-link.json"),
    function (browsers) {
